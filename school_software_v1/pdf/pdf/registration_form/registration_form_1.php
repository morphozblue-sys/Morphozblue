...
$query="select * from student_admission_info where student_roll_no='$student_roll_no' and session_value='$session1'";
...
while($row=mysqli_fetch_assoc($run)){ //echo '<pre>';print_r($row);
	...
	$student_registration_no=$row['student_registration_number'];
...
$student_roll_no=$_GET['id'];
	    ...
	    $this->Image('../../../images/blank.jpg',177,87,20,25);
		 ...
		 $this->Image($student_image,177,87,20,26,'jpeg');
	   }
	...
	$this->Cell(35,10.5,'',0);
    $this->Cell(130,10.5,''.$school_info_school_name,0,0,'C');
	$this->SetTextColor(255,0,0);
    $this->Ln();
    ...
    $this->Cell(35,6,"",0,'C');
	//$this->Cell(130,6,"Affiliated to CBSE New Delhi (Aff. No. 330844 School Code : $school_info_school_code)",0,0,'C');
	...
	$this->SetTextColor(0,0,0); 
    $this->Cell(35,6,"",0);
	$this->Cell(130,6,'Email :  '.$school_info_school_email_id.''.'        Website :'.$school_info_school_website,0,0,'C');
	$this->SetTextColor(0,0,0);  
	$this->Ln(); 
...
function Table2()
{
global $school_info_school_code,$school_info_dise_code,$school_info_registration_code,$student_date_of_admission,$student_name,$student_father_name,$student_mother_name,$student_date_of_birth,$student_gender,$student_religion,$student_category,$student_date_of_birth_in_word,$student_class,$student_adress,$student_father_contact_number,$student_admission_type,$student_admission_scheme,$student_medium,$student_facility,$student_child_id,$student_family_id,$student_adhar_number,$student_sssmid_number,$student_bank_name,$student_account_number,$student_bank_ifsc_code,$student_bank_ifsc_code,$student_previous_class,$student_previous_school_name,$student_bus,$student_hostel,$student_library,$student_remark_1,$student_remark_2,$student_registration_fee,$student_registration_no;
		...
		$this->Cell(81,5,'                  REGISTRATION FORM',0);
        $this->Cell(50,5,"",0);
		$this->Ln();
		...
		$this->SetFont('Times','b',12);
        $this->Cell(42,5,'Date Of Registration :',0);
		$this->SetFont('Times','',12);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 .........................................................................................................',0);
		$this->Cell(46,4,'1. Name of the Student',0);
		$this->Cell(5,4,':',0);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 .............................................................                          ..................',0);
		$this->Cell(46,4,"3. Date Of Birth",0);
		$this->Cell(5,4,':',0);
        $this->Cell(64,4,$student_date_of_birth,0);
		$this->Cell(26,4,"4. Gender",0);
		$this->Cell(2,4,":",0);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"5. Date Of Birth In Word",0);
		$this->Cell(5,4,':',0);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"6. Class Of Admission",0);
		$this->Cell(5,4,':',0);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"7. Father's Contact No.",0);
		$this->Cell(5,4,':',0);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 .............................................................                          ........................................',0);
		$this->Cell(46,4,"8. Admission Type",0);
		$this->Cell(5,4,':',0);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"9. Admission Scheme",0);
		$this->Cell(5,4,':',0);
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"10. Registration No ",0);
		$this->Cell(5,4,':',0);
        $this->Cell(50,4,$student_registration_no,0);
		$this->Ln();
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"11. Registration Fees",0);
		$this->Cell(5,4,':',0);
        $this->Cell(50,4,$student_registration_fee,0);
		$this->Ln();
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"12. Remark 1",0);
		$this->Cell(5,4,':',0);
        $this->Cell(50,4,$student_remark_1,0);
		$this->Ln();
		...
		$this->SetTextColor(0,0,0);
		$this->Cell(2,7.5,'                                                 ...............................................................................................................................',0);
		$this->Cell(46,4,"13. Remark 2",0);
		$this->Cell(5,4,':',0);
        $this->Cell(50,4,$student_remark_2,0);
		$this->Ln();	
...
$file_name="Registration_form".$student_name."_".$student_class.".pdf";
