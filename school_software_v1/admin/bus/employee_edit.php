      ...
      <div class="row">
          ...
          <div class="box box-warning  ">
            <div class="box-header with-border ">
              <h3 class="box-title"><?php echo $language['Employee Details']; ?></h3>
            </div>
            <!-- /.box-header -->
...
$que="select * from bus_staff_info where s_no='$s_no'";
...
?>
    ...
    <div class="box-body "  >
		...
		<h3 style="color:#d9534f;"><b><?php echo $language['Personal Detail']; ?></b></h3>
			...
			<div class="col-md-1 "  >	
					<div class="form-group">
					   <img id="emp_phroi12" src='<?php if($emp_photo!=''){ echo $_SESSION['amazon_file_path']."employee_document/".$emp_photo; }else{ echo $school_software_path."images/student_blank.png"; }  ?>' width='60px' height='60px' >
					</div>
				</div>	
		</div>	
		   <div class="col-md-4 ">				
