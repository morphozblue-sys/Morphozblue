...
<?php
$que11="select * from bus_staff_info";
		...
		<h3 style="color:#d9534f;"><b><?php echo $language['Personal Detail']; ?></b></h3>
			<div class="col-md-4 ">
				...
				<div class="form-group">
                    ...
                    <input type="text" required name="emp_name" placeholder="<?php echo $language['Employee Name']; ?>"  value="" class="form-control">
                </div>
		...
		<h3 style="color:#d9534f;"><b><?php echo $language['Salary Details']; ?></b></h3>
			<div class="col-md-4 ">				
				<div class="form-group">
                   ...
                   <input type="text" name="emp_pan_card_no" placeholder="<?php echo $language['Salary Details']; ?>"  value="" class="form-control">
                </div>
			</div>
