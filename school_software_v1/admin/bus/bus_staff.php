   ...
   <section class="content-header">
     ...
     <ol class="breadcrumb">
	  <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
	    ...
	    <li><i class="active"></i><?php echo $language['Bus Staff']; ?></li>
	</ol>
    </section>
    <!-- Main content -->
    <section class="content">
	  <div class="box <?php echo $box_head_color; ?> ">
		...
		<a href="javascript:get_content('bus/employee_add')">
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#E32636;">
            ...
            <a href="javascript:get_content('bus/employee_add')" class="small-box-footer"> <?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
        ...
        <div class="col-md-3 col-md-6">
          <div class="small-box" style="background-color:#B0BF1A;">
            ...
            <a href="javascript:get_content('bus/employee_list')" class="small-box-footer"> <?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
