            ...
            <div class="box-body table-responsive" id="printTable">
			  ...
			  <td style="float:right"><b>School Code : <?php echo $school_info_school_code; ?></b></td>
				  ...
				  <table cellspacing="0" cellpadding="10px;" border="1" id="example1" class="table table-bordered table-striped" style="width:100%;">
					...
					$count111=$student_data1+1;
					$sql="select s_no$info_column_name from student_admission_info where session_value='$session1' and student_status='Active' $filter37$condition1$condition2";
					...
					?>
					   <tr>
						  <td colspan="<?php echo $count111; ?>"><center><b>Data Not Found!!!</b></center></td>
					   </tr>
					<?php
					}
					?>
