...
$s_no1=$_GET['id'];
$que="select * from  classwork_student where s_no='$s_no1'";
$run=mysqli_query($conn73,$que);
$serial_no=0;

while($row=mysqli_fetch_assoc($run)){

	$classwork_class = trim($row['classwork_class']);
	$classwork_section = $row['classwork_section'];
	$classwork = $row['classwork'];
	$classwork_date_1 = $row['classwork_date'];
 ...
 $('#student_class_group').html("<option value='' >Loading....</option>");
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:get_content('homework/classwork')"><i class="fa fa-book"></i> <?php echo 'classwork'; ?></a></li>
        <li><a href="javascript:get_content('homework/classwork_list')"><i class="fa fa-list"></i>  <?php echo 'classwork List'; ?></a></li>
		<li class="active"><i class="fa fa-edit"></i>   <?php echo "Classwork"; ?></li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title"><?php echo "Classwork Edit"; ?></h3>
            </div>
            <!-- /.box-header -->
<!------------------------------------------------Start Registration form--------------------------------------------------->
            ...
            <div class="box-body "  >
			  ...
			  <div class="form-group" >
				 ...
				 <option value="<?php echo $classwork_class; ?>"><?php echo $classwork_class; ?></option>
					<?php 
				...
				<div class="col-md-3 " id="student_class_stream_div" <?php if($classwork_class!="11TH" || $classwork_class!="12TH"){ ?> style="display:none;" <?php } ?> >				
					<div class="form-group">
...
if($stream_name!=''){
		...
		<div class="col-md-3" id="student_class_group_div" <?php if($classwork_class!="11TH" || $classwork_class!="12TH"){ ?>style="display:none;" <?php } ?> >				
					<div class="form-group">
				...
				<div class="col-md-3 ">	
					<div class="form-group" >
						...
						<option value="<?php echo $classwork_section; ?>"><?php echo $classwork_section; ?></option>
					    </select>
					</div>
				</div>
								<div class="col-md-3 ">				
			  ...
			  <div class="col-md-3 ">	
			    ...
			    <input type="date" value="<?php echo $classwork_date; ?>" name="classwork_date" id="myLocalDate" class="form-control">
				 </div>
			  </div>
			  ...
			  <div class="col-md-3 ">		
				...
				<input type="text" name="classwork_remark" placeholder="Write Remark"  value="<?php echo $classwork_remark; ?>" class="form-control">
				</div>
			  </div>
			  </div>
              ...
              <div class="box-header with-border">
              <h3 class="box-title"><b><?php echo "classwork write here"; ?></b>
              </h3>
            ...
            <div class="box-body pad">
             ...
             <input type="text" id="question_box" rows="2" onKeyUp="get_text_question()" name="content" class="form-control" style="display:none">
                    ...
                    <textarea id="editor1" name="classwork" class="form-control bordder-color" placeholder="write homework" rows="10" cols="80" ><?php echo $classwork; ?></textarea>
