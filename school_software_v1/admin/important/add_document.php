			 ...
			 <div class="col-md-4 ">
						<div class="form-group">
						  <label>Name<font style="color:red"><b>*</b></font></label>
						   <input type="text"  name="document_name" style="  border-color: red;"   placeholder="Name"  value="" class="form-control" required>
						</div>
				</div>
				  <div class="col-md-4 ">	
					<div class="form-group" >
				...
				<div class="col-md-12">
				  <div class="col-md-4 ">	
					<div class="form-group" >
					  ...
					  <input type="file"  name="document_upload" placeholder="Upload Bill"  onchange="check_file_type(this,'document_upload','show_document_upload','image');" value="" class="form-control" required>
					</div>
				  </div>
                  	<div class="col-md-1">	
					<div class="form-group">
					   <img id="show_document_upload" src='<?php echo $school_software_path; ?>images/student_blank.png' width='60px' height='60px'>
					</div>
				</div>
				</div>  
				<div class="col-md-12">
