...
if(book_id==''){
alert_new('This book is not available right now');
$("#book_title_"+ser).val(''); 
   ...
   //loader();
        $.ajax({
			...
			$('#modal-default').modal('hide');
               var res=detail.split("|?|");
		   if(res[1]>0 && res[2]>0){
			    alert_new('Some Book Issue & Some Book can not Issue !!!');
			    get_content('library/view_book_library');
            }else{
                if(res[1]>0){
			    ...
			    alert_new('Sorry ! can not Issue Same Book to Same Student !!!');
			    get_content('library/view_book_library');
			    }
            }
			}
            ...
            <div class="box-body table-responsive">
             ...
             <table id="example1" class="table table-bordered table-striped">
               ...
               <tr>
				...
				<?php 
				$sql="select * from school_library_book where school_library_book_status='Active' and session_value='$session1'";
				$serial_no=0;
