      ...
      <div class="modal-content" >
	   <div class="modal-header">
        ...
        <div class="modal-body">
         <object data="<?php echo $path; ?>" type="application/pdf" width="100%" height="100%">
<iframe src="<?php echo $path; ?>" width="100%" height="100%" style="border: none;">
