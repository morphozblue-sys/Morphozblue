      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box <?php echo $box_head_color; ?>" >
			...
			$schl_result=mysqli_query($conn73,$schl_query)or die(mysqli_query($conn73));
			...
			?>
			  ...
			  <td style="float:right"><b>School Code : <?php echo $school_info_school_code; ?></b></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
                    ...
                    $age_condition=" and (YEAR(CURDATE()) - YEAR(student_date_of_birth)) <='$student_age'";
                    }
					...
					if($_SESSION['software_link']=='kdrsschoolgangapurcity'){
					    $filter37='';
					}
					
				    $query="select s_no$info_column_name,student_roll_no from student_admission_info where s_no!='' and session_value='$session1' and student_status='Active' $condition1$filter37$condition2$condition3$condition4$condition5$condition6$condition7$condition8$condition9$condition10$condition_scheme$condition12$condition14$condition13$age_condition$condition11";
					$result=mysqli_query($conn73,$query)or die(mysqli_query($conn73));
					$serial_no=0;
