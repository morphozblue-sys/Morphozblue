...
<!------------------------------------------------Start Registration form--------------------------------------------------->
            ...
            ?>
            <th><b style="font-size:15px"><input type="checkbox" name="std_class[]" id="" value="<?php echo $class_name; ?>" class="cls" checked /> <?php echo $class_name; ?>&nbsp;&nbsp;</b></th>
            <?php } ?>
            </div>
            ...
            ?>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_stream[]" id="" value="<?php echo $stream_name; ?>" class="stream" /> <?php echo $stream_name; ?>&nbsp;&nbsp;</b></th>
            <?php } ?>
            </div>
            ...
            <?php
            $query19="select * from school_info_stream_group where group_name!='' GROUP BY group_name";
            $run19=mysqli_query($conn73,$query19) or die(mysqli_error($conn73));
            while($row=mysqli_fetch_assoc($run19)){
            $group_name=$row['group_name'];
            ?>
            <th><b style="font-size:15px"><input type="checkbox" name="student_class_group[]" id="" value="<?php echo $group_name; ?>" class="group" /> <?php echo $group_name; ?>&nbsp;&nbsp;</b></th>
            <?php } ?>
            </div>
				...
				<div class="col-md-2">
			      ...
			      <div class="col-md-2 ">
				   ...
				   <div class="col-md-2 ">
					...
					<div class="col-md-2">		
						<div class="form-group">
						 <input type="checkbox" checked name="student_data[]" value="student_image_name|?|Student Photo" class="check_all"><th><b>Student Photo</b></th>
						</div>
					</div>
