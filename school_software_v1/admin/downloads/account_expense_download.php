...
//$('#printTable').print();
  ...
  <li><a href="javascript:get_content('downloads/downloads')"><i class="fa fa-phone-square"></i>Download panel</a></li>
	    <li><a href="javascript:get_content('downloads/account_expense_info')"><i class="fa fa-stack-overflow"></i>Account Expense</a></li>
	    <li class="active">Download Expense Info</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
		...
		<div class="col-md-12">
			  ...
			  <div class="col-md-6">
			  <center><button type="button" class="btn default" onclick="exportTableToExcel('printTable', 'Account Expense Report')"><i class="fa fa-print" aria-hidden="true"></i>Print In Excel</button></center>
			  </div>
			  <div class="col-md-6">
        ...
        <div class="col-md-12">
          ...
          <div class="box <?php echo $box_head_color; ?>" >
            ...
            <div class="box-body table-responsive" id="printTable">
			  ...
			  <td><center><b>ACCOUNT EXPENSE REPORT</b></center></td>
			  <td style="float:right"><b>School Code : <?php echo $school_info_school_code; ?></b></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" style="width:100%" border="1px" cellspacing="0px" cellpadding="10px;">
					...
					if($date_from!='')
					{
						$condition1=" and account_customer_date>='$date_from'";
					}
					else{
						$condition1='';
					}
					...
					if($date_to!='')
					{
						$condition2=" and account_customer_date<='$date_to'";
					}
				    else{
						$condition2='';
					}
					...
					if($order_by!=''){
					//if($order_by=='account_customer_name'){
				 ...
				 $query="select s_no$info_column_name from account_expence_info where account_amount_type='Debit' and account_status='Active'$condition1$condition2 and session_value='$session1'$condition11";
        ...
        <!-- /.col -->
			  ...
			  <div class="col-md-12">
			  <div class="col-md-6">
			  <center><button type="button" class="btn btn-success" onclick="exportTableToExcel('printTable', 'Account Expense Report')"><i class="fa fa-print" aria-hidden="true"></i>  Print In Excel</button></center>
			  </div>
			  <div class="col-md-6">
