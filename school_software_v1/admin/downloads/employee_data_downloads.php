			...
			?>
			  ...
			  <td style="float:right"><b>School Code : <?php echo $school_info_school_code; ?></b></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0">
					...
					$query="select s_no$info_column_name from employee_info where emp_status='Active'$condition$filter37$condition011$condition11";
					...
					<?php if($info_column_arr[$j]=='emp_dob' && $row[$info_column_arr[$j]]!=''){ ?>
