...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_fee_daily_collection_report.php?class_name="+class_name+"&section_name="+section_name+"&from_date="+from_date+"&to_date="+to_date+"&order_by="+order_by+"&student_bus_fee_category="+student_bus_fee_category+"&student_bus_route="+student_bus_route+"&student_bus="+student_bus+"&user_detail="+user_detail+"&fee_status="+fee_status+"&receipt_status="+receipt_status+"",
	  cache: false,
	  success: function(detail){
