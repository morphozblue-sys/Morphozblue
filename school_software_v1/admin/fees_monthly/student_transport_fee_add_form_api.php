...
$principal_owner_sms=$row22['blank_field_1'];
	...
	$fee_receipt_no11 = $_POST['fee_receipt_no11'];
	$fee_receipt_no1 = $fee_receipt_no+1;
	$fee_receipt_no111 = $fee_receipt_no11+1;
...
// 	$insert_column_value="";
    ...
    $search="select office_account_sno from common_fees_student_transport_fee_add";
    if(!mysqli_query($conn73,$search))
    {
     $add_new_column="ALTER TABLE common_fees_student_transport_fee_add ADD office_account_sno varchar(25) after paid_total";
     mysqli_query($conn73,$add_new_column);  
    }
    
    
    
 if($_SESSION['software_link']=='chandausischool'){ 
     	$quer22="insert into common_fees_student_transport_fee_add($insert_column_name fee_submission_date,student_name,student_father_name,student_roll_no,student_class,student_class_section,grand_total,balance_total,paid_total,office_account_sno,student_payment_mode,cheque_bank_name,cheque_no,cheque_date,neft_bank_name,neft_bank_account_no,session_value,blank_field_5,penalty_amount,fee_paid_months,other_fee_remark,other_fee_amount,blank_field_1,blank_field_2,student_previous_year_fee,student_previous_year_fee_balance,student_previous_year_fee_paid_total,$update_by_insert_sql_column) 
     	values($insert_column_value '$fee_submission_date','$student_name','$student_father_name','$student_roll_no','$student_class','$student_class_section','$grand_total','$balance_total','$total_paid','$office_account_sno','$student_payment_mode','$cheque_bank_name','$cheque_no','$cheque_date','$neft_bank_name','$neft_bank_account_no','$session1','$fee_receipt_no111','$penalty_fee','$month','$other_fee_remark','$other_fee_amount','$discount_remark','$discount_amount','$student_previous_year_fee','$student_previous_year_fee_balance','$student_previous_year_fee_paid',$update_by_insert_sql_value)";
    ...
    mysqli_query($conn73,$quer1);
      ...
      $quer112="update login set Trans_recipt='$fee_receipt_no111'";
      mysqli_query($conn73,$quer112);
 }else{
     
     	$quer22="insert into common_fees_student_transport_fee_add($insert_column_name fee_submission_date,student_name,student_father_name,student_roll_no,student_class,student_class_section,grand_total,balance_total,paid_total,office_account_sno,student_payment_mode,cheque_bank_name,cheque_no,cheque_date,neft_bank_name,neft_bank_account_no,blank_field_3,session_value,blank_field_5,penalty_amount,fee_paid_months,other_fee_remark,other_fee_amount,blank_field_1,blank_field_2,student_previous_year_fee,student_previous_year_fee_balance,student_previous_year_fee_paid_total,$update_by_insert_sql_column) values($insert_column_value '$fee_submission_date','$student_name','$student_father_name','$student_roll_no','$student_class','$student_class_section','$grand_total','$balance_total','$total_paid','$office_account_sno','$student_payment_mode','$cheque_bank_name','$cheque_no','$cheque_date','$neft_bank_name','$neft_bank_account_no','$transaction_no','$session1','$fee_receipt_no','$penalty_fee','$month','$other_fee_remark','$other_fee_amount','$discount_remark','$discount_amount','$student_previous_year_fee','$student_previous_year_fee_balance','$student_previous_year_fee_paid',$update_by_insert_sql_value)";
...
// 	$quer11="update login set $blank_field_column_name='$fee_receipt_no1',$update_by_update_sql";
 	...
 	$query="insert into ledger_info (emp_id_or_student_roll_no,emp_or_student_name,date,amount_type,payment_mode,total_amount,credit_or_debit_from,session_value,office_account_sno,$update_by_insert_sql_column) values('$student_roll_no','$student_name','$fee_submission_date','Credit','$student_payment_mode','$total_paid','transport','$session1','$office_account_sno',$update_by_insert_sql_value)";
