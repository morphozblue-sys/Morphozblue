...
$count=1;
$query = "select * from common_fees_student_fee_add where session_value='2019_20' and fee_status='Active' and student_transport_fee!=''";
...
$query1 = "update common_fees_student_fee_add set grand_total='$grand_total1',balance_total='$balance_total1',paid_total='$paid_total1',student_transport_fee='',student_transport_fee_balance='',student_transport_fee_paid_total='' where session_value='2019_20' and student_roll_no='$student_roll_no' and fee_status='Active'";	
