...
<?php if($_SESSION['software_link']=='rsainikschooljamui'){ ?>    
<tr><td colspan="8"><center><b style="color:black;font-size:20px;">Class : <?php echo $student_class.'  ,  '; ?>Section : <?php echo $student_class_section; ?></b></center></td></tr>    
<?php }else{ ?>
...
$que="select student_name,student_father_name,student_roll_no,school_roll_no,student_sms_contact_number,student_admission_number from student_admission_info where session_value='$session1'$condition$condition1$condition2$filter37";
...
if($_SESSION['software_link']=='pragyaschoolsasaram' || $_SESSION['software_link']=='hujaifaschooltura'){
$student_admission_number='<br> Adm. No.-'.$row['student_admission_number'].'/ Roll No.-'.$school_roll_no;
}
...
<td><span><?php echo $student_name.' / '.$student_father_name.$student_admission_number; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight:bold;color:red;"><?php echo $installment_amount; ?></span></td>
...
<?php if($_SESSION['database_name']!='simpthqt_kidzworldschoolrewa' || $_SESSION['software_link']=='rsainikschooljamui' ) { ?>
<td><span style="font-weight:bold;"><?php echo $serial_no.'.'; ?></span></td>
<td><span><?php echo $student_name.' / '.$student_father_name.$student_admission_number; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight:bold;color:black;"><?php echo $installment_amount; ?><br/>Transport Amount  -  <?php echo $transport_fee00; ?>/- <?php if($late_fee=='Yes'){ echo "<br/>Late Fee Amount  -  ".$late_fee00; } ?></span></td>
<td><span><input type="checkbox" name="student_sms_info[]" class="my_no" value="<?php echo $student_name.'|?|'.$student_sms_contact_number.'|?|'.$installment_amount.'|?|'.$transport_fee00.'|?|'.$late_fee00; ?>" checked /></span></td>
<td>&nbsp;</td>
<?php } ?>
