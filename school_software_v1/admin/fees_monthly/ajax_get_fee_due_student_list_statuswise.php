...
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Dues Amount :-  <?php echo $installment_amount; ?> /-</span><span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?php echo $fees_type_name; ?> )</span></td>
<td>&nbsp;</td>
</tr>
<?php if($_SESSION['database_name']!='simpthqt_kidzworldschoolrewa') {  ?>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Transport Amount :-  <?php echo $transport_fee00; ?> /- </td>   
<td>&nbsp;</td>
</tr>
<?php } ?>
<tr>
...
<?php if($late_fee=='Yes') {  ?>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Late Fee Amount :-  <?php echo $late_fee00; ?> /-</td>
</tr> 
<?php } ?>
<?php } } } ?>
</table>
