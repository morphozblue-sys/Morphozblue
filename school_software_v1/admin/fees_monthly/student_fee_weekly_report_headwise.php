...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_fee_weekly_report_headwise.php",
	  data: { class_name:class_name,section_name:section_name,from_date:from_date,to_date:to_date,order_by:order_by,student_bus:student_bus,student_fee_head:student_fee_head },
	  cache: false,
	  success: function(detail){
	      //alert('hit');
...
function for_print()
 ...
 newWin.close();
    ...
    <section class="content-header">
      <h1>
        Download Student Weekly Report
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-user-plus"></i>Weekly Report</li>
      </ol>
    </section>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12 col-md-offset-1" id="search_detail">
				...
				<input type="date" name="from_date" id="from_date" value="<?php $curr_date=date('Y-m-d'); echo date('Y-m-d',strtotime('-7 day', strtotime($curr_date))); ?>" class="form-control" oninput="for_list();" />
				</div>
				</div>
				...
				<option value=" ORDER BY class_code_no, student_class_section ASC">By Class</option>
				</select>
				</div>
				</div>
			...
			<div class="col-md-12 col-md-offset-3">
				...
				<select class="form-control" name="student_fee_head" id="student_fee_head" onchange="for_list();">
				<option value="All">All</option>
				<?php
