...
$.ajax({
	  ...
	  cache: false,
	  data:{ class_name:class_name, section_name:section_name, head_code:head_code, head_name:head_name, order_by:order_by, bus_fee_category:bus_fee_category, previous_head_dues:previous_head_dues, transport_head_dues:transport_head_dues },
	  success: function(detail){
