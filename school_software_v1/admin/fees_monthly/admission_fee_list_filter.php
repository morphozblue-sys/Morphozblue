...
<a href="javascript:get_content('fees_monthly/student_admission_fee_list')"><button style="float:right;" type="button" class="btn btn-info my_background_color" ><?php echo $language['Reset']; ?></button></a>
<button style="float:right;" type="button" class="btn btn-info my_background_color" data-toggle="collapse" data-target="#demo"><?php echo $language['Filter']; ?></button>
</div>
