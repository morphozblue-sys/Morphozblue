<?php include("../attachment/session.php")?>
    <section class="content-header">
	  ...
	  <li class="active">Add Transport Fee</li>
      </ol>
    </section>
...
function for_feelist(){
   ...
   $.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_add_transport_fee.php?student_class="+student_class+"&student_section="+student_section+"",
	  cache: false,
	  success: function(detail){
...
$.ajax({
	url: access_link+"fees_monthly/add_transport_fee_api.php",
	type: "POST",
	data: formdata,
	...
	success: function(detail){
	   ...
	   if(res[1]=='success'){
		   ...
		   get_content('fees_monthly/add_transport_fee');
	}
	}
 });
});
