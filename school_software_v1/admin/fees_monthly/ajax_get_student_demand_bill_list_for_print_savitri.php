...
$array_new = [];
foreach($student_due_month as $key)
{
    if(array_key_exists($key, $month_array))
    {
        $array_new[$key] = $month_array[$key];
    }
}
...
// if($fees_type_name1=='S'){
//     $fees_type_name11='September';
// }elseif($fees_type_name1=='O'){
//     $fees_type_name11='October';
// }elseif($fees_type_name1=='N'){
//     $fees_type_name11='November';
// }elseif($fees_type_name1=='D'){
//     $fees_type_name11='December';
// }elseif($fees_type_name1=='J'){
//     $fees_type_name11='January';
// }elseif($fees_type_name1=='F'){
//     $fees_type_name11='February';
// }elseif($fees_type_name1=='M'){
//     $fees_type_name11='March';
// }else{
//     $fees_type_name11=$fees_type_name1;
// }
...
<td><span style="font-size:18px;font-weight:bold;color:red;">Total Amount :-  <?php echo $final_amount+$student_previous_year_fee_balance; ?> /-</td>
...
<td><span>Month :- </span><span style="font-size:18px;font-weight:bold;color:red;">  <?php foreach($array_new as $value)
{
    echo $dte = $value;
    echo ",";
}
