...
<div class="col-md-12">
<div class="col-md-12">
    <span style="float:right;color:red;font-weight:bold;"><input type="checkbox" id="selected_student" onclick="for_check(this.id);" value="" checked /> All</span>
</div>
...
$que="select student_name,student_father_name,student_roll_no,school_roll_no,student_sms_contact_number,student_class,student_class_section,student_bus from student_admission_info where session_value='$session1'$condition$condition1";
...
?>
<tr>
<td><span style="font-size:14px;"><?php echo $student_name.' / '.$student_father_name; ?></span><span style="font-size:12px;float:right;"><?php echo $student_class.' ('.$student_class_section.')'; ?></span></td>
<td><span style="float:right;"><input type="checkbox" name="" class="selected_student" value="<?php echo $student_roll_no; ?>" checked /></span></td>
</tr>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Dues Amount :-  <?php echo $total; ?> /-</span><span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?php echo $fees_type_name; ?> )</span></td>
</tr>
<?php if($student_bus='Yes') { ?>
<tr>    
<td><span style="font-size:14px;font-weight:bold;color:red;">Transport Amount :-  <?php echo $student_transport_fee_balance; ?></span></td>
</tr>
<?php $student_transport_fee_balance1 = $student_transport_fee_balance; } ?>
<tr>    
<td><span style="font-size:14px;font-weight:bold;color:red;">Total Amount :-  <?php echo $total+$student_transport_fee_balance1; ?></span></td>
</tr>
...
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Paid Amount :-  <?php echo $total; ?> /-</span><span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?php echo $fees_type_name; ?> )</span><span style="font-size:14px;font-weight:bold;color:red;float:right;">Transport Amount :-  <?php echo $student_transport_fee_paid_total; ?></span></td>
<td>&nbsp;</td>
</tr>
