...
<div class="col-md-12">
<div class="col-md-6">
<center><button type="button" class="btn default" onclick="exportTableToExcel('printTable', 'Overall Report Studentwise')"><i class="fa fa-print" aria-hidden="true"></i>Print In Excel</button></center>
</div>
<div class="col-md-6">
...
?>
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <table id="example5" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
            <tr>
            <td>
			<?php
			...
			<td style="float:right"><b>School Code : <?php echo $school_info_school_code; ?></b></td>
				  ...
				  <?php
                    ...
                    $qry1="select student_roll_no,student_name,student_class,student_class_section,student_father_name,student_mother_name,student_admission_number from student_admission_info where student_status='Active' and session_value='$session1' and registration_final='yes'$condition$filter37";
				  ...
				  <table id="example2" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
					...
					<tbody>
					<?php
					$qry4="select * from ".$table_pre_name."fees_student_fee_add where fee_status='Active' and session_value='$session1'$condition";
				  ...
				  <table id="example3" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
					...
					<tbody>
					<?php
					$qry5="select * from ".$table_pre_name."fees_student_fee where fee_status='Active' and session_value='$session1'$condition";
        ...
        <!-- /.col -->
			  ...
			  <div class="col-md-12">
			  <div class="col-md-6">
			  <center><button type="button" class="btn my_background_color" onclick="exportTableToExcel('printTable', 'Overall Report Studentwise')"><i class="fa fa-print" aria-hidden="true"></i>  Print In Excel</button></center>
			  </div>
			  <div class="col-md-6">
