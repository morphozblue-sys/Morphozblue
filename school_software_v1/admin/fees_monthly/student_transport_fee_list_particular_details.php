...
document.getElementById('total_paid').value = add;
    ...
    <section class="content-header">
	  ...
	  <li class="active">Student Transport Fees List Particular Details</li>
      </ol>
    </section>
...
<!---*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************-->
    ...
    <form method="post" enctype="multipart/form-data">
		...
		<div class="box-body col-sm-12" style="border:1px solid;">
		<center><h2 style="color:teal;">Paid Transport Fee Details</h2></center>
            <?php				
				...
				$fee_balance1 = $row['transport_fee_balance_month'.$fee_paid_months_exp[$a]];
				$fee_paid1 = $row['transport_fee_paid_month'.$fee_paid_months_exp[$a]];
				$total_amount_after_discount1 = $row['transport_fee_amount_after_discount_month'.$fee_paid_months_exp[$a]];
				?>
				<div class="col-sm-6">				
				<div class="form-group">
                  <label>Transport Fee Paid Amount</label>
                  <input type="text" name="<?php echo 'transport_fee_paid_month'.$fee_paid_months_exp[$a]; ?>" value="<?php echo $fee_paid1; ?>" placeholder="amount" class="form-control" readonly />
                </div>
				</div>					
