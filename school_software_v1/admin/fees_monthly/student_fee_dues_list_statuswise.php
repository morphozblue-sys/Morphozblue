    ...
    <section class="content">
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            ...
            <!-- /.box-header -->			
        <div class="box-body">
		<div class="col-md-12" style="<?php if($_SESSION['database_name']!='simptylz_pragyaschoolsasaram'){ echo 'display:none;'; } ?>"><span style="float:right;color:red;"><input type="checkbox" name="late_fee" id="late_fee" onclick="for_msg();" /> Late Fee</span></div>
		<?php
		...
		<input type="hidden" id="school_database_name" value="<?php echo $_SESSION['database_name']; ?>" />
