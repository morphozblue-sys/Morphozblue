...
<div class="col-md-12">
<div class="col-md-12">
    <span style="float:right;color:red;font-weight:bold;"><input type="checkbox" id="selected_student" onclick="for_check(this.id,'No');" value="" checked /> All</span>
</div>
...
$que="select student_name,student_father_name,student_class,student_class_section,student_roll_no,school_roll_no,student_sms_contact_number from student_admission_info where session_value='$session1'$condition$condition1$condition2$filter37";
...
?>
<tr>
<td><span style="font-size:14px;"><?php echo $student_name.' / '.$student_father_name; ?></span><span style="font-size:12px;float:right;"><?php echo $student_class1.' ('.$student_class_section1.')'; ?></span></td>
<td><span style="float:right;"><input type="checkbox" name="" class="selected_student" value="<?php echo $student_roll_no; ?>" checked /></span></td>
</tr>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Transport Dues Amount :-  <?php echo $installment_amount; ?> /-</span><span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?php echo $fees_type_name; ?> )</span></td>
<td>&nbsp;</td>
</tr>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Previous Year Amount :-  <?php echo $student_previous_year_fee_balance; ?> /- </td>   
<td>&nbsp;</td>
</tr>
<?php } } } ?>
</table>
