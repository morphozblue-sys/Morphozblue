...
//  if($_SESSION['software_link']=='chandausischool'){
//         $blank_field_5789=$row2['blank_field_5_'.$session1];
//     }else{


 $blank_field_51=$row2['Trans_recipt'];
 $blank_field_column_name1="blank_field_5_".$session1;
	...
	?>
		...
		<center><h4 style="color:red;">Pay Transport Fees</h4></center>
	       ...
	       //echo "<script>window.open('set_fee_details.php?student_roll_no=$student_roll_no','_self')</script>";
				...
				$fee_balance1 = $row['transport_fee_balance_month'.$month_exp[$g]];
				if($fee_balance1==''){
				$fee_balance1=0;
				}
				$fee_paid1 = $row['transport_fee_paid_month'.$month_exp[$g]];
				...
				<div class="form-group">
                  ...
                  <input type="text" name="<?php echo 'transport_fee_balance_month'.$month_exp[$g];?>" placeholder="0" value="<?php echo $fee_balance1; ?>" id="<?php echo 'balance_tot_0_'.$g; ?>" class="form-control bal1" readonly />
                </div>
				</div>
				...
				<div class="form-group">
                  ...
                  <input type="number" name="<?php echo 'transport_fee_paid_month'.$month_exp[$g];?>" value="<?php echo $fee_balance1; ?>" placeholder="amount" id="<?php echo 'paid_tot_0_'.$g; ?>" oninput="total_fee();" step="1" max="<?php echo $fee_balance1; ?>" class="form-control amt" />
				...
				if(date('Y-m-d') > $dues_last_date[$month_exp[$g]] && $dues_last_date[$month_exp[$g]]!='0000-00-00'){
				    ...
				    $calculate_penalty=$calculate_penalty+$penalty_percent_rupees_amount[$month_exp[$g]];
				    }
				    }
				}else{
		    ...
		    <div class="col-md-12">
				...
				<div class="form-group">
                  ...
                  <input type="number" name="fee_receipt_no11" placeholder="" value="<?php if($blank_field_51==''){ echo $blank_field_51+1;}else{echo $blank_field_51;} ?>" class="form-control" readonly >
                </div>
                </div>
			 ...
			 <div class="col-md-1">				
		      <div class="form-group">
                  ...
                  <input type="text" name="penalty_fee" placeholder="0" value="<?php echo $calculate_penalty; ?>" class="form-control amt" oninput="total_fee();">
                </div>
             </div>
		        ...
		        <div class="col-md-12 ">
		            <div class="col-md-3">				
        		      <div class="form-group">
                          ...
                          <input type="number" placeholder="Enter Pay Amount" id="submission_amount" class="form-control" oninput="for_paid('1','<?php echo $month_count111; ?>');" />
                        </div>
                     </div>
		        </div>
		        <div class="col-md-12 ">
