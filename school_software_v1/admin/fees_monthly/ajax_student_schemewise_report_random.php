...
?>
        ...
        <div class="col-md-12">
          ...
          <div class="box">
			...
			$admission_scheme=$_GET['admission_scheme'];
			if($admission_scheme!='All'){
				$condition5=" and student_admission_scheme='$admission_scheme'";
			}else{
				$condition5="";
			}
			...
			<td colspan="3"><center><b>From <?php echo $from_date2; ?> To <?php echo $to_date2; ?></b></center></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
					...
					$que1="select * from common_fees_student_fee_add where fee_status='Active' and session_value='$session1'$condition1$condition2$condition3$condition4$order_by";
					...
					$que="select * from student_admission_info where student_status='Active' and student_roll_no='$student_roll_no' and session_value='$session1'$condition1$condition2$condition5";
					...
					<tfoot>
					<tr>
					<td colspan="10"><span style="float:right;font-weight:bold;">Total Amount = </span></td>
