...
function for_msg(){
	...
	$("#student_message").val("Dear Parents, Kindly deposit the "+month_arr+" due fees amount ? and transport dues amount ? of your child ? at the earliest. Regards, "+school_name);
}
...
function student_list(){
	...
	if(student_class!='' && student_class_section!='' && selected_month!='' && head_value!=''){
		...
		data: { student_class:student_class,student_class_section:student_class_section,student_status:student_status,selected_month:selected_month,head_value:head_value },
		cache: false,
		success: function(detail){
      ...
      <div class="row">
		...
		<div class="box-body  col-md-12">
		    ...
		    <div class="col-md-4" style="border:1px solid;border-radius:15px;">
				...
				?>
				<div class="col-md-6"><input type="radio" name="select_head" value="<?php echo $fee_code; ?>" class="my_head" /> <?php echo $fee_type; ?></div>
				<?php } ?>
		    </div>
		</div>
