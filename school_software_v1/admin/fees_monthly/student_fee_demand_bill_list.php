...
function print_list(){
	...
	<?php if($_SESSION['database_name']=='simptczo_savitriprabhapublicschool'){?>
	var url="ajax_get_student_demand_bill_list_for_print_savitri.php";
	<?php }else{?>
	var url="ajax_get_student_demand_bill_list_for_print.php";
	<?php } ?>
	
	if(student_class!='' && student_class_section!='' && student_due_month!=''){
		$.ajax({
		type: "POST",
		url: access_link+"fees_monthly/"+url,
    ...
    <section class="content">
      ...
      <div class="row">
		...
		<div class="col-md-10 col-md-offset-1">
            ...
            ?>
		    <div class="col-md-3">				
				<input type="checkbox" name="" value="<?php echo $fees_code; ?>" class="month" /> <?php echo $fees_type_name; ?>
			</div>
			<?php } ?>
