...
var student_bus_fee_category=document.getElementById('student_bus_fee_category').value;
...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_transport_balance_report.php?class_name="+class_name+"&section_name="+section_name+"&month_code="+month_code+"&order_by="+order_by+"&student_bus_fee_category="+student_bus_fee_category+"",
	  cache: false,
	  success: function(detail){
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12 col-md-offset-2" id="search_detail">
				...
				<select class="form-control" name="student_bus_fee_category" id="student_bus_fee_category" onchange="for_list();">
				<option value="All">All</option>
			<?php		
			$que="select student_bus_fee_category from student_admission_info where student_status='Active' and session_value='$session1' and student_bus_fee_category!='' group by student_bus_fee_category";
	...
	?>
		<option value="<?php echo $student_bus_fee_category; ?>"><?php echo $student_bus_fee_category; ?></option>
