          ...
          <div class="box">
			...
			<td colspan="3"><center><b>Classwise</b></center></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
					...
					$que="select * from student_admission_info where student_status='Active' and session_value='$session1'$condition1$condition2$order_by1";
					...
					$que1="select * from common_fees_student_transport_fee_add where fee_status='Active' and student_roll_no='$student_roll_no' and session_value='$session1'$condition1$condition2$condition5";
					...
					<tfoot>
					<tr>
					<td colspan="8"><span style="float:right;font-weight:bold;">Total Contribution = </span></td>
