...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12" id="search_detail">
				...
				<input type="date" name="from_date" id="from_date" value="<?php echo date('Y-m-01'); ?>" class="form-control" oninput="for_list();" />
				</div>
				</div>
				...
				<div class="form-group">
				<label>To Date</label>
				<input type="date" name="to_date" id="to_date" value="<?php echo date('Y-m-t'); ?>" class="form-control" oninput="for_list();" />
				</div>
				</div>
