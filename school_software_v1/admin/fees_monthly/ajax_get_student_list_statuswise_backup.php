...
<td><span><input type="checkbox" name="student_sms_info[]" class="my_no" value="<?php echo $student_name.'|?|'.$student_sms_contact_number.'|?|'.$installment_amount.'|?|'.$transport_fee00; ?>" checked /></span></td>
<td>&nbsp;</td>
<?php } ?>

<?php if($_SESSION['database_name']!='simpthqt_kidzworldschoolrewa') { ?>
<td><span style="font-weight:bold;"><?php echo $serial_no.'.'; ?></span></td>
<td><span><?php echo $student_name.' / '.$student_father_name; ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight:bold;color:red;"><?php echo $installment_amount; ?><br>Transport Amount  -  <?php echo $transport_fee00; ?>/-</span></td>
<td><span><input type="checkbox" name="student_sms_info[]" class="my_no" value="<?php echo $student_name.'|?|'.$student_sms_contact_number.'|?|'.$installment_amount.'|?|'.$transport_fee00; ?>" checked /></span></td>
<td>&nbsp;</td>
<?php } ?>
