...
<tr>
  ...
  <?php if($_POST['previous']=='previous'){?>
  <th>Total Previous</th>
  <th>Total Paid Previous</th>
  <th>Remaining Fee Previous</th>
  <?php } ?>
...
$total_previous=0;
$total_paid_previous=0;
$total_balance_previous=0;
while($row1=mysqli_fetch_assoc($run1)){
$grand_total=$row1['grand_total'];
$paidtotal=$row1['paid_total'];
$grand_total_total=$grand_total_total+$grand_total;
$total_previous=$row1['student_previous_year_fee'];
$total_paid_previous=$row1['student_previous_year_fee_paid_total'];
$total_balance_previous=$row1['student_previous_year_fee_balance'];;
...
<tr>
  ...
  <?php if($_POST['previous']=='previous'){?>
  <td><?php echo $total_previous;?></td>
  <td><?php echo $total_paid_previous;?></td>
  <td><?php echo $total_balance_previous;?></td>
  <?php } ?>
...
<tr>
  <?php if($_POST['previous']=='previous'){?>    
  <td colspan="10"><center><b>Total</b></center></td>
  <?php }else{?>
