...
function for_transport(){
    var student_roll_no = document.getElementById('selected_student').value;
    var month_code = [];
    var month_count=0;
    $(".fee_month").each(function() {
    if($(this).prop("checked") == true){
    ...
    if(month_count>0 && student_roll_no!=''){
    
    $.ajax({
    type: "POST",
    url: access_link+"fees_monthly/ajax_get_student_new_transport_fee.php",
    data: {student_roll_no:student_roll_no,month_code:month_code,month_count:month_count},
    cache: false,
    success: function(detail){
    alert(detail);
    // var str=detail.split('|?|');
    ...
    <section class="content">
      ...
      <div class="row">
		...
		<div class="box-body  col-md-12">
			...
			<div class="col-md-8">
			<div class="col-md-6">
			    <input type="checkbox" value="Yes" id="new_transport" onclick="for_transport();" /><b style="color:blue;"> Transport Fee</b>
			</div>
			<div class="col-md-6">
		...
		<center><h4 style="color:red;"><?php echo $language['Pay Fees']; ?></h4></center>
	       ...
	       //echo "<script>window.open('set_fee_details.php?student_roll_no=$student_roll_no','_self')</script>";
				...
				<div class="form-group">
                  ...
                  <input type="number"  name="transport_fee_paid" value="<?php echo $transport_payable_amt; ?>" placeholder="Transport Fee Paid" step="1" max="<?php echo $student_transport_fee_balance; ?>" oninput="total_fee();" id="transport_fee_paid1" class="form-control amt" <?php if (isset($_GET['student_roll_no'])) { echo ''; } else { echo 'readonly'; } ?> />
                </div>
				</div>
		        </div>
				...
				<div class="col-md-12" id="new_transport_fee"></div>
		    ...
		    <div class="col-md-12">
				...
				<div class="form-group">
                  ...
                  <input type="number" name="fee_receipt_no" placeholder="" value="<?php if($blank_field_5==''){ echo $blank_field_5+1;}else{echo $blank_field_5;} ?>" class="form-control">
                </div>
                </div>
				<div class="col-md-2">
				<div class="form-group">
