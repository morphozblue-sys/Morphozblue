...
<tr>
<td><span style="font-size:18px;font-weight:bold;color:red;">Transport Dues Amount :-  <?php echo $installment_amount; ?> /-</span><span style="font-size:18px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?php echo $fees_type_name; ?> )</span></td>
</tr>
<tr>
