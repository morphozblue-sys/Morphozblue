...
$final_amount=$student_transport_fee_balance+$total;
$serial_no++;
if($student_transport_fee_balance==''){$student_transport_fee_balance=0;}
?>
<tr>
<td><span style="font-size:14px;"><?php echo $student_name.' / '.$student_father_name.' / '.$student_admission_number.' / '.$school_roll_no; ?></span><span style="font-size:12px;float:right;"><?php echo $student_class.' ('.$student_class_section.')'; ?></span></td>
<td><span style="float:right;"><input type="checkbox" name="" class="selected_student" value="<?php echo $student_roll_no; ?>" checked /></span></td>
</tr>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Dues Amount :-  <?php echo $total; ?>/-</span><span style="font-size:12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?php echo 'Till '.$fees_type_name1; ?> )</span></td>
</tr>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Transport Amount :-  <?php echo $student_transport_fee_balance; ?> /-</td>
<td>&nbsp;</td>
</tr>
...
?>
<tr>
<td><span style="font-size:14px;font-weight:bold;color:red;">Previous Dues Amount :-  <?php echo $student_previous_year_fee_balance; ?> /-</td>
<td>&nbsp;</td>
</tr>
<?php
}
...
<td><span style="font-size:18px;font-weight:bold;color:red;">Total Amount :-  <?php echo $final_amount; ?> /-</td>
