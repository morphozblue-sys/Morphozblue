...
$.ajax({
	  type: "POST",
	  url: access_link+"fees_monthly/ajax_student_classwise_transport_fee_report_installmentwise.php?class_name="+class_name+"&section_name="+section_name+"&order_by="+order_by+"&user_detail="+user_detail+"",
	  cache: false,
	  success: function(detail){
		 $("#pdf_detail").html(detail);
	  }
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <div class="col-md-4"><h3 class="box-title">Classwise Transport Fee Report download</h3></div>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12" id="search_detail">
				...
				?>
				<option value="<?php echo $user_id; ?>"><?php echo $user_name.' ['.$user_id.']'; ?></option>
				<?php } ?>
				</select>
				</div>
				</div>
