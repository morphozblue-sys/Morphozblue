...
function for_print()
 ...
 <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
  	...
  	$que123="select * from school_info_class_info";
	    ...
	    $student_age_detail[$class_name."Female"][$m]="";
            ...
            <div class="box-body table-responsive">   
              ...
              <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" style="width:100%">
                <thead>
                <tr>
				  <th >Age</th>
				  <th >Gender</th>
	...
	$serial_no++;
                ...
                <tr>
                  <td rowspan="3"><b><?php  echo ($x)."-".($x+1);  ?></b></td>
                  <th>Boys</th>
                   	 <?php 
				 for($y=0;$y<count($class_array);$y++){	
		     $class_name=$class_array[$y];
		     ...
		     $class_name=$class_array[$y];
				  ?>
				  <td><b><?php echo $student_age_detail[$class_name."Other"][$x] ; ?></b></td>
				       	 <?php } ?>
		     ...
		     $class_name=$class_array[$y];
				  ?>
				  <td><b><?php echo $student_age_detail[$class_name."Other"]['20+'] ; ?></b></td>
				       	 <?php } ?>
                 
                </tr>
                       <tr>
                  <td rowspan="3"><b>No DOB FOUND</b></td>
                  <th>Boys</th>
                   	 <?php 
				 for($y=0;$y<count($class_array);$y++){	
		     $class_name=$class_array[$y];
		     ...
		     $class_name=$class_array[$y];
				  ?>
				  <td><b><?php echo $student_age_detail[$class_name."Other"]['NO DOB'] ; ?></b></td>
				       	 <?php } ?>
		     ...
		     $class_name=$class_array[$y];
				  ?>
				  <td><b><?php echo$student_classwise_total[$class_name]; ?></b></td>
				    	 <?php } ?>
                    </tr>
                </tfoot>
             </table>
