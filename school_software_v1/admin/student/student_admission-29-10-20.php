...
function mimeType(headerString) {
  ...
  return type;
    ...
    var formdata = new FormData(this);
        ...
        $.ajax({
            url: access_link+"student/student_admission_api-29-10-20.php",
            type: "POST",
            data: formdata,
...
function for_bus_category(){
 ...
 <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
	...
	$student_remark_5=$row['student_remark_5'];
	$student_remark_6=$row['student_remark_6'];
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
		...
		<div class="box-body ">
			...
			<div class="col-md-1">	
				...
				<div class="col-md-2">
					<div class="form-group">
					  <label><?php echo "Remark 5"; ?></label>
					   <input type="text"  name="student_remark_5"   value="<?php echo $student_remark_5; ?>" class="form-control">
					</div>
			    </div>
			    
			    <div class="col-md-2">
					<div class="form-group">
					  <label><?php echo "Remark 6"; ?></label>
					   <input type="text"  name="student_remark_6"   value="<?php echo $student_remark_6; ?>" class="form-control">
					</div>
			    </div>
