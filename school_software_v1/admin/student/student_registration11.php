...
function myFunction() {
    ...
    var student_registration_fee = document.getElementById("student_registration_fee").value;
    var school_name123 = document.getElementById("school_name123").value;
    var text = document.getElementById("text");
    if (checkBox.checked == true){
        text.style.display = "block";
		$('#contact').val('Dear '+student_name+',Your Registration Have Completed Successfully And Your Registration Fees '+student_registration_fee+'. Thanking You '+school_name123);
		 $('#send_sms').val('Yes');
    } else {
...
//     $("#get_content").html(loader_div);
        $.ajax({
            url: access_link+"student/student_registration_api11.php",
            type: "POST",
            data: formdata,
    ...
    <div class="box-body">
				...
				<div class="col-md-3" style="<?php if($fees_type=='fees1'){ echo 'display:none;'; } ?>">				
					<div class="form-group" >
					  ...
					  <input type="text" name="student_registration_fee" id="student_registration_fee" oninput="myFunction();" placeholder="<?php echo $language['Registration Fees']; ?>"  value="" class="form-control">
					</div>
				</div>
