...
function check_function()
{
    ...
    $.ajax({
        type:"POST",
        url:access_link+"student/report_student_strength_cityewise_filter_checked.php?checked="+value+"",
        cache:false,
 ...
 <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
          ...
          <div class="box <?php echo $box_head_color; ?>">
			...
			?>
			 <div class="col-md-12">
			  ...
			  <div class="col-md-6">
				<span style="font-size:20px;font-weight:bold"><center>City Wise STUDENT STRENGTH INFO</center></span>
			  </div>
			  <div class="col-md-3">
        ...
        <!--            </tr>-->
				...
				<?php				
                    ...
                    $total_other_student_total=0;
                      ...
                      $que123="select DISTINCT student_city from student_admission_info order by s_no";
                      
                      
                    $run123=mysqli_query($conn73,$que123);
                    $serial_no=0;
				while($row123=mysqli_fetch_assoc($run123)){
				$student_city=$row123['student_city'];
                $serial_no++;
				
				
 				
                $color="white";
				$que="select * from student_admission_info where student_status='Active' and student_city='$student_city' and session_value='$session1'$filter37";
				$run=mysqli_query($conn73,$que);
				$total_student_city_wise=0;
				while($row=mysqli_fetch_assoc($run)){
				$total_student_city_wise++;
				}
			
				$que="select * from student_admission_info where student_status='Active' and student_city='$student_city' and student_gender='Male' and session_value='$session1'$filter37";
				$run=mysqli_query($conn73,$que);
				...
				$que="select * from student_admission_info where student_status='Active' and student_city='$student_city' and student_gender='Female' and session_value='$session1'$filter37";
				$run=mysqli_query($conn73,$que);
	...
	$other_student_total=$other_student_total_male+$other_student_total_female;
                ...
                <tr>
                  ...
                  <td><b><?php echo $student_city; ?></b></td>
                  
                  
                  <td><b><?php echo $total_student_city_wise ; ?></b></td>
      ...
      <!--            <td><b><?php echo $other_student_total ; ?></b></td>-->
                ...
                <?php 
                 $total_total_student_class_wise=$total_total_student_class_wise+$total_student_city_wise;
 ...
 ?>
				<tr>
                    <td><b></b></td>
                    <td style="color:red;"><b>All City</b></td>
