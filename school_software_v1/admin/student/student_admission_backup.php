...
function myFunction() {
    ...
    var sms_cont="Dear Parents, Thanks for choosing us for a bright future of "+student_name+" Regards - "+school_name+"";
...
function for_bus_category(){
 ...
 <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
	...
	$student_image=$row1['student_image_name'];
	 $student_father_image=$row1['student_father_image_name'];
	$student_mother_image=$row1['student_mother_image_name'];
	$student_guardian_image=$row1['student_guardian_image_name'];
	$student_tc_image=$row1['student_tc_image_name'];
	$student_last_marksheet_image=$row1['student_last_marksheet_image_name'];
	$student_income_certificate_image=$row1['student_income_certificate_image_name'];
	$student_cast_certificate_image=$row1['student_cast_certificate_image_name'];
	$student_dob_image=$row1['student_dob_image_name'];
	$student_adhar_card_image=$row1['student_adhar_card_image_name'];
	$student_sssmid_image=$row1['student_sssmid_image_name'];
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<h3 style="color:#d9534f;"><b><?php echo $language['Admission Details']; ?>:</b></h3>
				...
				<div class="col-md-3 ">
						<div class="form-group">
						   ...
						   <select name="student_admission_class" class="form-control">
						       ...
						       <option value="NURSERY" <?php if($student_admission_class=='NURSERY'){ echo 'selected'; }?>>NURSERY</option>
						       <option value="LKG" <?php if($student_admission_class=='LKG'){ echo 'selected'; }?>>LKG</option>
						       <option value="UKG" <?php if($student_admission_class=='UKG'){ echo 'selected'; }?>>UKG</option>
						       <option value="1ST" <?php if($student_admission_class=='1ST'){ echo 'selected'; }?>>1ST</option>
						       <option value="2ND" <?php if($student_admission_class=='2ND'){ echo 'selected'; }?>>2ND</option>
						       <option value="3RD" <?php if($student_admission_class=='3RD'){ echo 'selected'; }?>>3RD</option>
						       <option value="4TH" <?php if($student_admission_class=='4TH'){ echo 'selected'; }?>>4TH</option>
						       <option value="5TH" <?php if($student_admission_class=='5TH'){ echo 'selected'; }?>>5TH</option>
						       <option value="6TH" <?php if($student_admission_class=='6TH'){ echo 'selected'; }?>>6TH</option>
						       <option value="7TH" <?php if($student_admission_class=='7TH'){ echo 'selected'; }?>>7TH</option>
						       <option value="8TH" <?php if($student_admission_class=='8TH'){ echo 'selected'; }?>>8TH</option>
						       <option value="9TH" <?php if($student_admission_class=='9TH'){ echo 'selected'; }?>>9TH</option>
						       <option value="10TH" <?php if($student_admission_class=='10TH'){ echo 'selected'; }?>>10TH</option>
						       <option value="11TH" <?php if($student_admission_class=='11TH'){ echo 'selected'; }?>>11TH</option>
						       <option value="12TH" <?php if($student_admission_class=='12TH'){ echo 'selected'; }?>>12TH</option>
						   </select>
               ...
               <div class="col-md-3 ">
				...
				<div class="col-md-3" id="div_bus_fee_ctgry_name" style="<?php //if($student_bus=='No'){ echo 'display:none'; } ?>">				
					<div class="form-group">
					  <label>Bus Fee Category</label>
					    <select class="form-control select2" name="bus_fee_category_name" id="bus_fee_category_name" onchange="for_route();" style="width:100%;">
					           <option  value="">Select</option>
						       <?php
				...
				<div class="col-md-3">				
                    ...
                    <select class="form-control select2" name="student_bus_route" id="student_bus_route" onchange="for_no();" style="width:100%;">
                    <option value="">Select</option>
                    <?php
                    //if($student_bus=='Yes'){
				...
				<div class="col-md-3">				
					<div class="form-group" >
					  <label><?php echo "Boarding";//language['Hostel']; ?></label>
		...
		<div class="box-body ">
			...
			<div class="col-md-1">	
                ...
                <input type="text" name="sms_content" id="sms_content" value="Dear Parents, Thanks for choosing us for a bright future of <?php echo $student_name; ?> Regards - <?php echo $school_info_school_name; ?>" class="form-control" />
                </div>
                </div>
                </div>
