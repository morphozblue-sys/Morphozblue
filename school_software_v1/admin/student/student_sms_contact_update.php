...
$("#my_form").submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(detail) {
            ...
            if (res[1] === 'success') {
                alert_new('SMS contacts updated successfully', 'green');
            } else {
...
<section class="si-ph">
  <div class="si-ph-left">
    <div class="si-ph-badge"><i class="fa fa-mobile"></i></div>
    <div>
      <h1 class="si-ph-title">Student SMS Contact Update</h1>
  ...
  <nav class="si-ph-bc">
    ...
    <span class="si-bc-sep"><i class="fa fa-chevron-right"></i></span>
    <span class="si-bc-active"><i class="fa fa-mobile"></i> SMS Contact Update</span>
  </nav>
</section>
