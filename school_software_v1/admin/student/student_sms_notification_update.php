...
function for_search11() {
    ...
    if (student_class !== '' || student_class_section !== '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "student/ajax_student_sms_notification_update.php?student_class=" + student_class +
...
$("#my_form").submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(detail) {
            ...
            if (res[1] === 'success') {
                alert_new('Notification settings updated successfully', 'green');
            } else {
...
<section class="si-ph">
  <div class="si-ph-left">
    <div class="si-ph-badge"><i class="fa fa-bell"></i></div>
    <div>
      <h1 class="si-ph-title">Student SMS Notification Update</h1>
  ...
  <nav class="si-ph-bc">
    ...
    <span class="si-bc-sep"><i class="fa fa-chevron-right"></i></span>
    <span class="si-bc-active"><i class="fa fa-bell"></i> SMS Notification Update</span>
  </nav>
</section>
