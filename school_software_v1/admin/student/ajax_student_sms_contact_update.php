...
<table id="example2" class="table table-bordered table-striped">
	...
	<th>New SMS Contact</th>
	<th>Old SMS Contact</th>
	</tr>
	</thead>
	<tbody>
<?php
...
while($row=mysqli_fetch_assoc($run)){
    ...
    $serial_no++;
    if($student_sms_contact_number==''){
        $student_sms_contact_number=$student_father_contact_number;
    }
	?>
  <tr>
	...
	<td><input type="text" name="student_father_contact_number[]" class="" title="<?php echo $student_name; ?>" value="<?php echo $student_father_contact_number; ?>" oninput="set_contact(this.value,'<?php echo $student_roll_no; ?>');"></td>
	<td><input type="text" name="student_sms_contact_number[]" class="" id="<?php echo 'sms_contact_'.$student_roll_no; ?>" title="<?php echo $student_name; ?>" value="<?php echo $student_sms_contact_number; ?>"></td>
	<td><input type="text" name="" class="" title="<?php echo $student_name; ?>" value="<?php echo $student_sms_contact_number; ?>" style="background-color:#E6E6E6;" readonly></td>
  </tr>
	<?php  $serial_no11++; } ?>
     </tbody>
     </table>
