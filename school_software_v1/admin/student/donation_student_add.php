...
function for_section(value) {
    ...
    $.ajax({
        ...
        cache: false,
        success: function(detail) { $("#student_class_section").html(detail); }
    });
}
...
function for_search11() {
    ...
    if (student_class !== '' || student_class_section !== '') {
        ...
        $.ajax({
            type: "POST",
            url: access_link + "student/ajax_donation_student_add.php?student_class=" + student_class +
...
$("#my_form").submit(function(e) {
    ...
    $.ajax({
        url: access_link + "student/donation_student_add_api.php",
        ...
        success: function(detail) {
            ...
            get_content('student/donation_student_add');
        }
    });
});
</script>
...
<section class="si-ph">
  <div class="si-ph-left">
    <div class="si-ph-badge"><i class="fa fa-gift"></i></div>
    <div>
      <h1 class="si-ph-title">Donation Students</h1>
  ...
  <nav class="si-ph-bc">
    ...
    <span class="si-bc-sep"><i class="fa fa-chevron-right"></i></span>
    <span class="si-bc-active"><i class="fa fa-gift"></i> Donation Students</span>
  </nav>
</section>
