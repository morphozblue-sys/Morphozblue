...
include("../attachment/image_compression_upload.php");
   ...
   $student_image=$_FILES['student_photo']['name'];            
	...
	$query="insert into ledger_info (emp_id_or_student_roll_no,emp_or_student_name,date,amount_type,payment_mode,total_amount,credit_or_debit_from,session_value,$update_by_insert_sql_column) values('$student_roll_no','$student_name','$student_date_of_admission','Credit','Cash','$student_registration_fee','fee','$session1',$update_by_insert_sql_value)";
