...
function check_function()
{
    ...
    $.ajax({
        type:"POST",
        url:access_link+"student/report_student_strength_castewise_filter_checked_new.php?checked="+value+"",
        cache:false,
 ...
 <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
          ...
          <div class="box <?php echo $box_head_color; ?>">
			...
			?>
			 <div class="col-md-12">
			  ...
			  <div class="col-md-6">
				<span style="font-size:20px;font-weight:bold"><center>Caste Wise New STUDENT STRENGTH INFO</center></span>
			  </div>
			  <div class="col-md-3">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
				...
				<?php				
                    ...
                    $que123="SELECT DISTINCT student_caste FROM student_admission_info order by s_no";
                    
                    $run123=mysqli_query($conn73,$que123);
                    $serial_no=0;
				while($row123=mysqli_fetch_assoc($run123)){
				$student_caste=$row123['student_caste'];
                $serial_no++;
				
				
 				
                $color="white";
				$que="select * from student_admission_info where student_status='Active' and student_caste='$student_caste' and session_value='$session1'$filter37";
				...
				$que="select * from student_admission_info where student_status='Active' and student_caste='$student_caste' and student_gender='Male' and session_value='$session1'$filter37";
				$run=mysqli_query($conn73,$que);
				...
				$que="select * from student_admission_info where student_status='Active' and student_caste='$student_caste' and student_gender='Female' and session_value='$session1'$filter37";
				$run=mysqli_query($conn73,$que);
	...
	$other_student_total=$other_student_total_male+$other_student_total_female;
                ...
                <tr>
                  ...
                  <td><b><?php echo $student_caste; ?></b></td>
