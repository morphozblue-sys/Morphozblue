      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title"><?php echo $language['Mother Generate ID']; ?></h3>
            </div>
            <!-- /.box-header -->
...
while($row=mysqli_fetch_assoc($run)){
	$id_card_mother_pdf = $row['id_card_mother_pdf'];
}	
   ?>
          	
            <div class="box-body "  >
					<form role="form"  method="post" id="my_form" action="<?php echo $pdf_path; ?>id_card_page_mother/<?php echo $id_card_mother_pdf; ?>" onsubmit="return checked_null_value();" enctype="multipart/form-data" target="_blank">
