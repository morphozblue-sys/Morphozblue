...
$que="select * from event_table where event_name='$s_no'";
			 ...
			 <div class="col-md-6 ">
						<div class="form-group">
						  <label>Event Name<font style="color:red"><b>*</b></font></label>
						   <input type="text"  name="event_name" placeholder="Add Event Name"  value="<?php echo $event_name; ?>" class="form-control">
						</div>
				</div>
				
				<div class="col-md-6 ">				
					 <div class="form-group" >
					  <label >Event Type<font style="color:red"><b>*</b></font></label>
				...
				<div class="col-md-3 ">				
					 <div class="form-group" >
					  <label >Event Activity<font style="color:red"><b>*</b></font></label>
					  <select class="form-control" name="event_activity">
					   <option><?php echo $event_activity; ?></option>
					 <option>Dancing</option>
					  <option>Singing</option>
				...
				<div class="col-md-3 ">
						<div class="form-group">
						  <label>Event Date<font style="color:red"><b>*</b></font></label>
				...
				<div class="col-md-6 ">
						<div class="form-group">
						  <label>Event Venue<font style="color:red"><b>*</b></font></label>
						   <input type="text"  name="event_address" placeholder="Add Event Venue Details" value="<?php echo $event_address; ?>" class="form-control">
						</div>
				</div>
