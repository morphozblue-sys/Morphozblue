...
<?php
$student_roll_no="2201168";
$student_id_generate="1168";

 	$que2="select * from student_admission_info_old where  s_no>1168";
...
//	$student_id_generate=$row2['student_id_generate'];
	...
	$session_value=$row2['session_value'];
	$medium=$row2['medium'];
	$shift=$row2['shift'];
	$board=$row2['board'];
