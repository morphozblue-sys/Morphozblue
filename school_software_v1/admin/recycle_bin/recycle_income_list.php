...
$.ajax({
type: "POST",
url: access_link+"recycle_bin/recycle_income_list_delete.php?id="+s_no+"",
cache: false,
success: function(detail){
	  var res=detail.split("|?|");
			   if(res[1]=='success'){
				   alert_new('Successfully Deleted','green');
				   get_content('recycle_bin/recycle_income_list');
			   }else{
               //alert_new(detail); 
			   }
}
...
$.ajax({
type: "POST",
url: access_link+"recycle_bin/recycle_income_list_restore.php?id="+s_no+"",
cache: false,
success: function(detail){
	  var res=detail.split("|?|");
			   if(res[1]=='success'){
     ...
     <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Income List Recycle Bin</li>
      </ol>
    </section>
...
$que="select * from  account_income_info where account_income_status='Deleted'";
...
while($row=mysqli_fetch_assoc($run)){
		...
		$path="../documents/account/".$account_customer_name;
...
?>
	...
	<th  ><a href="<?php echo $path."/".$bill_upload; ?>" target="_blank">Downlode File</a></th>
