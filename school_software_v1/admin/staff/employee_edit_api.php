<?php include("../attachment/session.php");
 include("../attachment/image_compression_upload.php");
	...
	$blank_field_5=$_POST['blank_field_5'];
    ...
    $quer="update employee_info set emp_name='$emp_name',emp_gender='$emp_gender',emp_dob='$emp_dob',emp_father='$emp_father',emp_email='$emp_email',emp_mobile='$emp_mobile',emp_address='$emp_address',emp_qualification='$emp_qualification',emp_doj='$emp_doj',emp_categories='$emp_categories',emp_designation='$emp_designation',emp_pan_card_no='$emp_pan_card_no',emp_bank_name='$emp_bank_name',emp_account_no='$emp_account_no',emp_ifsc_code='$emp_ifsc_code',emp_basic_salary='$emp_basic_salary',emp_pf_number='$emp_pf_number',emp_uid_no='$emp_uid_no',emp_subject_preferred='$emp_subject_preferred',emp_class_preferred='$emp_class_preferred',remarks='$remarks',emp_rf_id_no='$emp_rf_id_no',emp_leave_cl='$emp_leave_cl',emp_leave_pl='$emp_leave_pl',emp_leave_sl='$emp_leave_sl',emp_other_wages='$emp_other_wages',emp_leave_other='$emp_leave_other',medium='$emp_medium',shift='$emp_shift',pf_deduction='$pf_deduction',hra_amount='$hra_amount',da_amount='$da_amount',emp_allowance='$emp_allowance',tds_deduction='$tds_deduction',esic_deduction='$esic_deduction',ptax_deduction='$ptax_deduction',blank_field_1='$emp_sssm_id',blank_field_5='$blank_field_5',$update_by_update_sql  where s_no='$s_no'";
