<?php include("../attachment/session.php");
  ...
  $query="insert into student_tc(tc_student_roll_no,tc_generate_no,tc_student_sssm_id_no,tc_student_uid_no,tc_student_name,tc_student_father_name,tc_mother_name,date_of_birth,date_of_birth_in_word,tc_admission_no,tc_admission_date,tc_student_class,tc_student_class_leaving,tc_student_class_section,class_in_which_admitted,date_of_school_leaving,region_for_leaving,tc_subject,due_if_any,conduct_and_behaviour,session_value,blank_field_1,blank_field_2,blank_field_3,blank_field_4,blank_field_5,total_num_working,num_of_days_present,date_of_application,any_other_remark,any_other_remark1,any_other_remark2,any_other_remark3,any_other_remark4,any_other_remark5,any_other_remark6,any_other_remark7,any_other_remark8,month_pupil_has_paid,$update_by_insert_sql_column) values ('$tc_student_roll_no','$tc_generate_no','$tc_student_sssm_id_no','$tc_student_uid_no','$tc_student_name','$tc_student_father_name','$tc_mother_name','$date_of_birth','$date_of_birth_in_word','$tc_admission_no','$tc_admission_date','$tc_student_class','$tc_student_class_leaving','$tc_student_class_section','$class_in_which_admitted','$date_of_school_leaving','$region_for_leaving','$tc_subject','$due_if_any','$conduct_and_behaviour','$session1','$due_date','$any_fee_concession','$result_status','$Games_Played_Or_Extra_Activity','$wheather_ncc_scount_guide','$total_num_working','$num_of_days_present','$date_of_application','$any_other_remark','$any_other_remark1','$any_other_remark2','$any_other_remark3','$any_other_remark4','$any_other_remark5','$any_other_remark6','$any_other_remark7','$any_other_remark8','$paid_month',$update_by_insert_sql_value)";
