				 ...
				 <div class="col-md-3 ">	
				  ...
				  <div class="col-md-3 ">	
					<div class="form-group" >
					  ...
					  <input type="text"  name="Remark" placeholder=""  value="" class="form-control">
					</div>
				  </div>
				  <?php if($_SESSION['software_link']=='vidyaviharchanda'){?> 
				 <div class="col-md-3 ">	
					<div class="form-group" >
					   <label><?php echo "Nationality"; ?></label>
					  <input type="text"  name="Nationality" placeholder=""  value="" class="form-control">
					</div>
				  </div>
				 
				 <div class="col-md-3 ">	
					<div class="form-group" >
					   <label><?php echo "Place Of Birth"; ?></label>
					  <input type="text"  name="Place_Of_Birth" placeholder=""  value="" class="form-control">
					</div>
				  </div>
				  
				  <div class="col-md-3 ">	
					<div class="form-group" >
					   <label><?php echo "Last School Attend"; ?></label>
					  <input type="text"  name="Last_School_Attend" placeholder=""  value="" class="form-control">
					</div>
				  </div>
				  
				  <div class="col-md-3 ">	
					<div class="form-group" >
					   <label><?php echo "Other Remark"; ?></label>
					  <input type="text"  name="Other_Remark" placeholder=""  value="" class="form-control">
					</div>
				  </div>
