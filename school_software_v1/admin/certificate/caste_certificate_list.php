...
success: function(detail){
    ...
    <section class="content-header">
      ...
      <li class="active"><?php echo $language['Caste Certificate List']; ?></li> </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box <?php echo $box_head_color; ?> ">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $language['Caste Certificate List']; ?></h3>
            </div>
            <!-- /.box-header -->
...
?>
                <?php
                $qry="select * from caste_certificate where student_caste_status='Active' and session_value='$session1' order by s_no DESC";
                ...
                <tr>
			     ...
			     <td><button type="button" onclick="post_content('certificate/caste_certificate_form_edit','<?php echo 'id='.$s_no; ?>')"  class="btn btn-success"><?php echo $language['Edit']; ?></button></td>
