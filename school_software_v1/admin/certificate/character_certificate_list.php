...
while($row321=mysqli_fetch_assoc($run321)){
	$character_certificate = $row321['character_certificate'];
}	
?>
                <?php
                $qry="select * from character_certificate where student_character_status='Active' and session_value='$session1' order by s_no DESC";
                ...
                $character_issue_date = $row22['character_issue_date'];
                ...
                <tr>
                  ...
                  <td><?php echo $character_student_name; ?></td>
                  <td><?php echo $character_student_father_name; ?></td>
				  <td><?php echo $character_student_roll_no; ?></td>
				  <td><?php echo $character_school_name; ?></td>
				  <td><?php echo $character_current_year_from; ?> - <?php echo $character_current_year_to; ?></td>
				  <td><?php echo $character_issue_date; ?></td>
                  <td><?php echo $character_type; ?></td>
                  
                  <td><?php echo $update_change; ?></td>
                  <td><?php echo $last_updated_date; ?></td>
                  
                 <td><a href='<?php echo $pdf_path; ?>certificate_page/<?php echo $character_certificate; ?>?id=<?php echo $s_no; ?>' target="_blank"><button type="button" class="btn btn-success"><?php echo $language['Print']; ?></button></a></td>
			     <td><button type="button" onclick="post_content('certificate/character_certificate_form_edit','<?php echo 'id='.$s_no; ?>')"  class="btn btn-success"><?php echo $language['Edit']; ?></button></td>
