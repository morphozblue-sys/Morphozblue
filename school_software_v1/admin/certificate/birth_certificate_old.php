...
if(mysqli_query($conn73,"select birth_certificate_pdf from school_info_pdf_info")){
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-6 ">				
					...
					<option value="">Select student</option>
					  ...
					  <div class="col-md-12">
    					   <br/><center><a href="<?php echo $pdf_path; ?>certificate_page/<?php echo $other_certificate.'?student_roll_no='.$student_roll_no; ?>" target="_blank"  class="btn btn-success">Submit</a></center><br/>
					  </div>
		</form>	
		<div class="col-md-12">
		</div>
