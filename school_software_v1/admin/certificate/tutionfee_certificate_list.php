...
success: function(detail){
    ...
    <section class="content-header">
      ...
      <li class="active"><?php echo $language['Tutionfee Certificate List']; ?></li> </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box <?php echo $box_head_color; ?> ">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $language['Tutionfee Certificate List']; ?></h3>
            </div>
            <!-- /.box-header -->
...
while($row321=mysqli_fetch_assoc($run321)){
	$tutionfee_certificate = $row321['tutionfee_certificate'];
}	
?>
                <?php
                $qry="select * from tutionfee_certificate where student_tutionfee_status='Active' and session_value='$session1' order by s_no DESC";
                ...
                $tutionfee_issue_date = $row22['tutionfee_issue_date'];
                ...
                <tr>
                  ...
                  <td><?php echo $tutionfee_student_name; ?></td>
                  <td><?php echo $tutionfee_student_father_name; ?></td>
				  <td><?php echo $tutionfee_student_roll_no; ?></td>
				  <td><?php echo $tutionfee_school_name; ?></td>
				  <td><?php echo $tutionfee_current_year_from; ?> - <?php echo $tutionfee_current_year_to; ?></td>
				  <td><?php echo $tutionfee_issue_date; ?></td>
                  <td><?php echo $tutionfee_type; ?></td>
                  
                  <td><?php echo $update_change; ?></td>
                  <td><?php echo $last_updated_date; ?></td>
                  
                 <td><a href='<?php echo $pdf_path; ?>certificate_page/<?php echo $tutionfee_certificate; ?>?id=<?php echo $s_no; ?>' target="_blank"><button type="button" class="btn btn-success"><?php echo $language['Print']; ?></button></a></td>
			     <td><button type="button" onclick="post_content('certificate/tutionfee_certificate_form_edit','<?php echo 'id='.$s_no; ?>')"  class="btn btn-success"><?php echo $language['Edit']; ?></button></td>
