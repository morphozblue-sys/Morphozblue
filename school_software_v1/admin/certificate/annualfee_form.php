...
window.scrollTo(0, 0);
    ...
    <section class="content-header">
      ...
      <li class="active"><?php echo $language['Bonafied Certificate Form']; ?></li> </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title"> <?php echo $language['Bonafied Certificate Generate']; ?></h3>
            </div>
            <!-- /.box-header -->
					...
					<div class="form-group">
			          ...
			          <div class="col-md-3 ">
						<div class="form-group">
						  <label><?php echo $language['Student Name']; ?></label>
						   <input type="text"  name="annualfee_student_name" value="" placeholder="<?php echo $language['Student Name']; ?>"   id="student_name" class="form-control" readonly>
					       </div>
					  </div>
					  ...
					  <div class="col-md-3 ">	
					    <div class="form-group" >
					     ...
					     <input type="text"  name="annualfee_student_father_name" id="student_father_name" placeholder="<?php echo $language['Father Name']; ?>"  value="" class="form-control" readonly>
					    </div>
				      </div>
					  ...
					  <div class="col-md-3 ">	
						  ...
						  <input type="text" name="annualfee_student_roll_no"  value="" placeholder="<?php echo $language['Student Roll No']; ?>"  id="student_roll_no" class="form-control" readonly>
					      </div>
				      </div>
					  ...
					  <div class="col-md-3 ">
						<div class="form-group">
						  <label><?php echo $language['School Name']; ?></label>
						   <input type="text"  name="annualfee_school_name" value="<?php echo $_SESSION['school_info_school_name5']; ?>" placeholder="<?php echo $language['School Name']; ?>" required  class="form-control" >
					       </div>
					  </div>
				     ...
				     <div class="col-md-3">	
						<div class="form-group" >
						 <label> <?php echo $language['AnnualFee Amt']; ?></label>
						  <input type="text"  name="annualfee_type" placeholder="<?php echo $language['AnnualFee Amt']; ?>"  value="" class="form-control" required>
						</div>
					  </div>
					  ...
					  <div class="col-md-3 ">	
						<div class="form-group" >
						 <label><?php echo $language['Issued Date']; ?></label>
						  <input type="date"  name="annualfee_issue_date"  placeholder="<?php echo $language['Issued Date']; ?>"  value="" class="form-control" required>
						</div>
					  </div>
