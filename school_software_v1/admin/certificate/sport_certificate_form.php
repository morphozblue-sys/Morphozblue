...
<script type="text/javascript">
   ...
   <section class="content-header">
      ...
      <li class="active"><?php echo $language['Sports Certificate Form']; ?></li> </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title"><?php echo $language['Sports Certificate Generate']; ?></h3>
            </div>
            <!-- /.box-header -->
			 ...
			 <div class="col-md-6 ">				
					<div class="form-group" >
			          ...
			          <div class="col-md-3 ">
						<div class="form-group">
						  <label><?php echo $language['Student Name']; ?></label>
						   <input type="text"  name="sport_student_name" value="" placeholder="<?php echo $language['Student Name']; ?>"   id="student_name" class="form-control" readonly>
					       </div>
					  </div>
					  ...
					  <div class="col-md-3 ">	
						  ...
						  <input type="text" name="sport_student_roll_no"  value="" placeholder="<?php echo $language['Student Roll No']; ?>"  id="school_roll_no" class="form-control" readonly>
					      </div>
				      </div>
				     ...
				     <div class="col-md-3 ">	
						<div class="form-group" >
						 <label> <?php echo $language['Sports Type']; ?></label>
						  <input type="text"  name="sport_type" placeholder="<?php echo $language['Sports Type']; ?>"  value="" class="form-control" required>
						</div>
					  </div>
					  ...
					  <div class="col-md-3 ">	
						<div class="form-group" >
						 <label><?php echo $language['Organized Date']; ?></label>
						  <input type="date"  name="sport_organized_date" id="date_of_school_leaving" placeholder="<?php echo $language['Organized Date']; ?>"  value="" class="form-control" required>
						</div>
					  </div>
				      ...
				      <div class="col-md-3 ">	
					    ...
					    <label> <?php echo $language['Rank']; ?></label>
					     <input type="text"  name="sport_rank" placeholder="<?php echo $language['Rank']; ?>"  value="" class="form-control" required>
					   </div>
				     </div>
