...
$query1="select * from ledger_info where date>='$from_date' AND date <='$to_date' AND ledger_status='Active' and amount_type='Debit' ORDER BY s_no DESC";
$serial_no=0;
...
<?php
$query11="select * from ledger_info where date>='$from_date' AND date <='$to_date' AND ledger_status='Active' and amount_type='Credit'";
