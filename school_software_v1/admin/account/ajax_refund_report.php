...
<div class="col-md-12">
<div class="col-md-6">
<center><button type="button" class="btn default" onclick="exportTableToExcel('printTable', 'Refund Report')"><i class="fa fa-print" aria-hidden="true"></i>Print In Excel</button></center>
</div>
<div class="col-md-6">
<center><button type="button" class="btn default" onclick="for_print();"><i class="fa fa-print" aria-hidden="true"></i>Print In Pdf</button></center>
        ...
        <div class="col-md-12">
          ...
          <div class="box <?php echo $box_head_color; ?> ">
			...
			<td><center><b><?php if($income_expense=='Credit'){ echo 'Income'; }elseif($income_expense=='Debit'){ echo 'Refund'; }else{ echo 'Income/Expense'; } ?> Report</b></center></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
						<thead >
								<tr>
								  <th>#</th>
								  <th>Date</th>
								  <th><?php if($income_expense=='Credit'){ echo 'Income'; }elseif($income_expense=='Debit'){ echo 'Refund'; }else{ echo 'Income/Expense'; } ?> Details</th>
								  <th><?php if($income_expense=='Credit'){ echo 'Income'; }elseif($income_expense=='Debit'){ echo 'Refund'; }else{ echo 'Income/Expense'; } ?> Amount</th>
								  <th>Payment Mode</th>
								</tr>
						</thead>
					<tbody>
        ...
        <!-- /.col -->
			  ...
			  <div class="col-md-12">
			  <div class="col-md-6">
			  <center><button type="button" class="btn btn-success" onclick="exportTableToExcel('printTable', 'Refund Report')"><i class="fa fa-print" aria-hidden="true"></i>  Print In Excel</button></center>
			  </div>
			  <div class="col-md-6">
