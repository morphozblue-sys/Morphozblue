...
<div class="col-md-12">
<div class="col-md-6">
<center><button type="button" class="btn default" onclick="exportTableToExcel('printTable', 'Income/Expense Report')"><i class="fa fa-print" aria-hidden="true"></i>Print In Excel</button></center>
</div>
<div class="col-md-6">
<center><button type="button" class="btn default" onclick="for_print();"><i class="fa fa-print" aria-hidden="true"></i>Print In Pdf</button></center>
          ...
          <div class="box <?php echo $box_head_color; ?> ">
			...
			<td style="float:right;">From : <?php echo $from_date1; ?> To : <?php echo $to_date1; ?></td>
				  ...
				  <table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
					...
					<tbody>
					<?php
					$que1="select * from ledger_info where ledger_status='Active' and blank_field_3!='Refund' and session_value='$session1'$condition01$condition02$condition03$condition4 ORDER BY date";
					$run1=mysqli_query($conn73,$que1);
					$serial_no1=0;
					$grand_total_amount1=0;
					$grand_total_amount2=0;
					$total_amount1=0;
					$total_amount2=0;
					...
					$income_exp_detail=$account_customer_name.' - '.$account_customer_contact_no.' ( '.$account_customer_remark.' )';
					}
					}elseif($credit_or_debit_from=='fee'){
					$que2="select student_name,student_father_name,student_class,student_class_section from student_admission_info where session_value='$session1' and student_roll_no='$emp_id_or_student_roll_no'";
					...
					$income_exp_detail='Fee ( '.$student_name.' / '.$student_father_name.' [ '.$student_class.' - '.$student_class_section.' ] )';
					...
					if($amount_type=='Credit'){
                        ...
                        $total_amount2=0;
                        $grand_total_amount1=$grand_total_amount1+$total_amount1;
					}elseif($amount_type=='Debit'){
					    $total_amount1=0;
                        $total_amount2=$total_amount;
                        $grand_total_amount2=$grand_total_amount2+$total_amount2;
					}
					...
					<td><span style="font-weight:bold;"><?php echo $grand_total_amount1; ?></span></td>
					<td><span style="font-weight:bold;"><?php echo $grand_total_amount2; ?></span></td>
					<td><span style="font-weight:bold;">&nbsp;</span></td>
					</tr>
					<tr>
					<td colspan="6" style="height:100px;"><span style="float:right;">Signature........................................</span></td>
					</tr>
					</tfoot>
				 </table>
        ...
        <!-- /.col -->
			  ...
			  <div class="col-md-12">
			  <div class="col-md-6">
			  <center><button type="button" class="btn btn-success" onclick="exportTableToExcel('printTable', 'Income/Expense Report')"><i class="fa fa-print" aria-hidden="true"></i>  Print In Excel</button></center>
			  </div>
			  <div class="col-md-6">
