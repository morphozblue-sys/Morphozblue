  ...
  <section class="content-header">
      ...
      <ol class="breadcrumb">
       <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
		...
		<li><a href="javascript:get_content('account/add_income_or_expence_info')"><i class="fa fa-list"></i>Add Info</a></li>
          ...
          <div class="box <?php echo $box_head_color; ?> ">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
				$ledger_sno=$_GET['id'];
				$que="select * from ledger_info where account_status='Active' and s_no='$ledger_sno'";
				...
				<td> <img onclick="open_file1('bill_upload','account_expence_info','s_no','<?php echo $s_no;?>');" src="<?php if($bill_upload!=''){ echo 'data:image;base64,'.$bill_upload; }else{ echo "../".$school_software_path."images/student_blank.png"; }  ?>"  height="50" width="50" style="margin-top:10px;"></td>		
				<td><a href='edit_expence_info.php?id=<?php echo $s_no; ?> '><button type="button" class="btn btn-success" >Edit</button></a></td>
				<td><a href='expence_delete.php?id=<?php echo $s_no; ?> '><button type="button" class="btn btn-danger" onclick="return valid();" >Delete</button></a></td>
				</tr>				
				<?php } ?>
                </tbody>
             </table>
