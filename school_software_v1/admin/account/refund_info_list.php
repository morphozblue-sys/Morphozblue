          ...
          <div class="box <?php echo $box_head_color; ?> ">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
				...
				$que="select * from account_expence_info where account_status='Active'  and session_value='$session1' and blank_field_3='Refund' ORDER BY s_no DESC";
