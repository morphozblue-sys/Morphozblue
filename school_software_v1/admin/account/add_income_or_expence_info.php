...
window.scrollTo(0, 0);
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li class="active"><?php echo $language['Account Info']; ?></li>
      </ol>
    </section>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
    ...
    <div class="box-body">
		<form role="form" method="post" enctype="multipart/form-data" id="my_form">
				...
				<?php if($_SESSION['database_name1']=='scholarsscientific'){ ?>
				
				<div class="col-md-3">				
					<div class="form-group">
					  <label>Office Account</label>
					    <select name="office_account_info" class="form-control select2"  onchange="account_cust1(this.value);">
					    <option value="">Select</option>
					    <?php
					    ...
					    ?>
					    <option value="<?php echo $bank_account_holder_name.' ( '.$bank_account_no.' )'; ?>"><?php echo $bank_account_holder_name.' ( '.$bank_account_no.' )'; ?></option>
					    <?php } ?>
					    </select>
					</div>
				</div>
				...
				<div class="col-md-4">
					 <div class="form-group">
						<label><?php echo $language['Name']; ?></label>
						<input type="text"  name="account_customer_name" placeholder="<?php echo $language['Name']; ?>" id="student_name11" value="" class="form-control" readonly >
					 </div>
				</div>
				<?php }else{ ?>
				...
				<div class="col-md-4 ">		
						<div class="form-group">
						  <label><?php echo $language['Total Amount']; ?><font style="color:red"><b>*</b></font></label>
						   <input type="number" name="account_customer_total_amount" id="account_customer_total_amount" oninput="same_amount(this.value,'advance_amount');" placeholder="<?php echo $language['Total Amount']; ?>"  value="" class="form-control" required>
						</div>
				</div>
				<div class="col-md-4 ">	
				    <div class="form-group" >
				...
				<div class="col-md-4">				
                    ...
                    <input type="text" name="transaction_no" placeholder="Transaction Id/No"  value="" class="form-control">
                    </div>
                    </div>
				    <div class="col-md-4">		
						<div class="form-group">
