...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"stock_management/add_stock_item_uniform_api.php",
            type: "POST",
            data: formdata,
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title"><b>Add New Uniform</b></h1>
              <div class="btnadd">
              </div>
            </div>
            <!-- /.box-header -->
				...
				<table class="table table-responsive" id="item_table">
				    <thead>
				        <tr>
    				        ...
    				        <th>Item Color <span style="color:red;">*</span></th>
    				        <th>Item Size <span style="color:red;">*</span></th>
    				        <th style="display:none;">Item Class <span style="color:red;">*</span></th>
				    ...
				    <tbody>
    				    <tr>
    				        ...
    				        <td>
    					       <input type='text'  name='item_description[]' placeholder='Item Color'  value='' class='form-control' required />
    				        </td>
    				        <td>
        				        <input type='text' name='item_size[]' placeholder='Item Size' value='' class='form-control' required />
    				        </td>
