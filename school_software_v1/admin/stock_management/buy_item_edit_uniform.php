...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"stock_management/buy_item_edit_uniform_api.php",
            type: "POST",
            data: formdata,
...
$query12 = "select * from purchase_detail_uniform where invoice_number='$invoice_number' and session_value='$session1' and purchase_status='Active'";
            ...
            <div class="box-body">
                ...
                <div class="col-md-2">
    			    <div class ="form-group">
                        ...
                        <input type="number" name="invoice_no" class="form-control" id="invoice_no" value="<?php echo $invoice_number; ?>" required <?php if($_SESSION['database_name1']!='livingstonenagaland'){ echo 'readonly'; } ?> />
                    </div>
                </div>
				    ...
				    <tbody id="item_table">
    				    ...
    				    <tr id="<?php echo 'tr_'.$serial_no; ?>">
    				        ...
    				        <td>
                                ...
                                <?php
                                $query_v = "select * from new_stock_item_uniform where stock_item_status='Active'";
                                $reslt_v = mysqli_query($conn73,$query_v);
                                while($row_v=mysqli_fetch_assoc($reslt_v)){
                                ...
                                ?>
                                <option <?php if($item_s_no1[$i]==$item_s_no){ echo 'selected'; } ?> value="<?php echo $item_s_no; ?>"><?php echo $item_name.' ['.$item_size.']-['.$item_description.']'; ?></option>
                                <?php } ?>
                                </select>
