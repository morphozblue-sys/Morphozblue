...
<div class="col-md-12">
<div class="col-md-6">
<center><button type="button" class="btn default" onclick="exportTableToExcel('printTable', 'Stock Return Report')"><i class="fa fa-print" aria-hidden="true"></i>Print In Excel</button></center>
</div>
<div class="col-md-6">
    ...
    <div class="col-md-12">
          ...
          <div class="box <?php echo $box_head_color; ?>">
			...
			if($from_date!=''){
				...
				$condition3=" and return_detail.invoice_date>='$from_date'";
			}else{
				$from_date2='';
				$condition3="";
			}
			...
			if($to_date!=''){
				...
				$condition4=" and return_detail.invoice_date<='$to_date'";
			}else{
				$to_date2='';
				$condition4="";
			}
			...
			<td><center><b>BOOKS STOCK RETURN REPORT</b></center></td>
			...
			<td colspan="3"><center><b>From <?php echo $from_date2; ?> To <?php echo $to_date2; ?></b></center></td>
				...
				<table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
				    ...
				    <tbody>
					<?php
					$que1="select return_detail.*, new_stock_item.item_name, new_stock_item.item_class, vendor_detail.vendor_name from return_detail join new_stock_item on return_detail.item_s_no=new_stock_item.s_no join vendor_detail on return_detail.vendor_id=vendor_detail.s_no where return_detail.return_status='Active'$condition3$condition4$order_by";
        ...
        <!-- /.col -->
			  ...
			  <div class="col-md-12">
			  <div class="col-md-6">
			  <center><button type="button" class="btn btn-success" onclick="exportTableToExcel('printTable', 'Stock Return Report')"><i class="fa fa-print" aria-hidden="true"></i>  Print In Excel</button></center>
			  </div>
			  <div class="col-md-6">
