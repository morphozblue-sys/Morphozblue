    ...
    <section class="content">
		...
		<div class="box <?php echo $box_head_color; ?>">
            <div class="box-header with-border">
			  <div class="col-md-6"><h4>Uniform Purchase List</h4></div>
			  <div class="col-md-6"><a href="javascript:get_content('stock_management/add_buy_item_uniform')"> <button style="float:right;" type="button" class="btn btn-primary">+ Buy Item</button></a></div>
			</div>
...
<?php
$que="select pd.*, vd.vendor_name from purchase_detail_uniform as pd left join vendor_detail as vd on pd.vendor_s_no=vd.s_no where pd.purchase_status='Active' and pd.session_value='$session1' group by pd.invoice_number ORDER BY pd.invoice_number DESC";
