...
if(rbtn_value=='Student'){

$.ajax({
	  type: "POST",
	  url: access_link+"stock_management/ajax_sale_report_uniform.php?sales_type="+rbtn_value+"&order_by="+order_by+"&from_date="+from_date+"&to_date="+to_date+"",
	  cache: false,
 ...
 newWin.close();
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-user-plus"></i>Sale Report</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <div class="col-md-4"><h3 class="box-title">Uniform Sale Report download</h3></div>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12 col-md-offset-1" id="search_detail">
				...
				<option value=" ORDER BY sale_detail_uniform.invoice_date ASC">By Date</option>
				<option value=" ORDER BY sale_detail_uniform.invoice_number ASC">By Invoice No</option>
				</select>
				</div>
				</div>
				<div class="col-md-2"></div>
