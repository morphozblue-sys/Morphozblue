...
$query0="select * from purchase_detail_uniform where invoice_number='$invoice_no' and session_value='$session1' and purchase_status='Active'";
...
$query="update purchase_detail_uniform set purchase_status='Edited',$update_by_update_sql where invoice_number='$invoice_no' and session_value='$session1' and purchase_status='Active'";
