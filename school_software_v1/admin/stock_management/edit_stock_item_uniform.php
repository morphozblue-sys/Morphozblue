...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"stock_management/edit_stock_item_uniform_api.php",
            type: "POST",
            data: formdata,
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title"><b>Edit Stock Uniform</b></h1>
            </div>
            <!-- /.box-header -->
<!------------------------------------------------Start Personal Detail--------------------------------------------------->
            ...
            <div class="box-body">
				...
				<table class="table table-responsive" id="item_table">
				    ...
				    <?php
				    $sno=$_GET['id'];
				    $que="select nst.*, ns.available_stock, ns.opening_stock from new_stock_item_uniform as nst left join new_stock_uniform as ns on ns.item_s_no=nst.s_no where nst.s_no='$sno' ";
				    ...
				    <tbody>
    				    <tr>
    				        ...
    				        <td>
    					       <input type='text' name='item_description' placeholder='Item Color' value='<?php echo $item_description; ?>' class='form-control' required />
    				        </td>
    				        <td>
        				        <input type='text' name='item_size' placeholder='Item Size' value='<?php echo $item_size; ?>' class='form-control' required />
    				        </td>
