...
if($search_item_name!='All'){
    $condition2=" and nst.item_name='$search_item_name'";
}else{
    $condition2="";
}
$search_item_color=$_GET['search_item_color'];
if($search_item_color!='All'){
    $condition3=" and nst.item_description='$search_item_color'";
}else{
    $condition3="";
}
$search_item_size=$_GET['search_item_size'];
if($search_item_size!='All'){
    $condition4=" and nst.item_size='$search_item_size'";
}else{
    $condition4="";
}
?>
              <table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
                <?php
                $que="select nst.*, ns.opening_stock, ns.sale_rate from new_stock_item_uniform as nst join new_stock_uniform as ns on ns.item_s_no=nst.s_no where nst.stock_item_status='Active'$condition1$condition2$condition3$condition4 order by nst.s_no desc";
