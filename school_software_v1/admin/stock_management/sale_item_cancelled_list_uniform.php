    ...
    <section class="content">
		...
		<div class="box <?php echo $box_head_color; ?>">
            <div class="box-header with-border">
			  <div class="col-md-6"><h4>Uniform Sale Cancelled List</h4></div>
			  <div class="col-md-6" style="display:none;"><a href="javascript:get_content('stock_management/add_sale_item_uniform')"> <button style="float:right;" type="button" class="btn btn-primary">+ Sale Item</button></a></div>
			</div>
            <!-- /.box-header -->
...
$que="select * from sale_detail_uniform where sale_status='Cancelled' and session_value='$session1' group by invoice_number ORDER BY invoice_number DESC";
