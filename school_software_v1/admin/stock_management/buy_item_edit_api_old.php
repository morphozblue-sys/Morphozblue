...
if($result>0){
 ...
 $quer1="update new_stock_ledger set ledger_account_type='Debit',ledger_type='Vendor',ledger_student_customer_id='$vendor_s_no',ledger_invoice_date='$invoice_date',ledger_item_s_no='$ledger_item_s_no',ledger_payable_amount='$total_payable_amount',ledger_payment_mode='$payment_mode',ledger_cheque_bank_name='$cheque_bank_name',ledger_cheque_date='$cheque_date',ledger_cheque_number='$cheque_no',ledger_neft_bank_name='$neft_bank_name',ledger_neft_bank_acount_number='$neft_bank_account_no',$update_by_update_sql where ledger_invoice_no='$invoice_no' and ledger_status='Active' and session_value='$session1' and ledger_account_type='Debit' and ledger_type='Vendor'";
