...
$.ajax({
type: "POST",
url: access_link+"stock_management/purchase_item_add_in_stock_uniform_api.php?item_s_no="+item_s_no+"&quantity="+quantity+"&s_no="+s_no+"",
cache: false,
success: function(detail){
    var res=detail.split("|?|");
	    if(res[1]=='success'){
            alert_new('Successfully Completed');
            get_content('stock_management/purchase_item_add_in_stock_uniform');
        }else{
            //alert_new(detail); 
	    }
    }
...
$.ajax({
type: "POST",
url: access_link+"stock_management/ajax_get_minimum_alert_detail_uniform.php?item_s_no="+item_s_no+"",
cache: false,
success: function(detail){
...
$("#myModal_close").click();
$.ajax({
    url: access_link+"stock_management/stock_item_minimum_alert_uniform_api.php",
    type: "POST",
    data: formdata,
    ...
    <section class="content">
		...
		<div class="box <?php echo $box_head_color; ?>">
            <div class="box-header with-border">
			  <div class="col-md-12"><h3>Purchase Uniform Add In Stock</h3></div>
			</div>
			
            <!-- /.box-header -->
            <div class="box-body table-responsive">
            <div class="col-md-12">
            <div class="col-md-12"><h4>Uniform Purchase List</h4></div>
...
<?php
$que="select pd.*, vd.vendor_name, nsi.item_name, nsi.item_description, nsi.item_size, nsi.item_class, nsi.item_category from purchase_detail_uniform as pd left join vendor_detail as vd on pd.vendor_s_no=vd.s_no join new_stock_item_uniform as nsi on pd.item_s_no=nsi.s_no  where pd.add_in_stock='No' and pd.purchase_status='Active' and pd.session_value='$session1' ORDER BY pd.invoice_number ASC";
...
<?php } ?>
    ...
    <div class="col-md-12">
    <div class="col-md-12"><h4>Uniform Stock List</h4></div>
...
<?php
$que1="select ns.*, nsi.item_name, nsi.item_size, nsi.item_description, nsi.item_class, nsi.item_category from new_stock_uniform as ns join new_stock_item_uniform as nsi on ns.item_s_no=nsi.s_no where nsi.stock_item_status='Active' order by ns.s_no ASC";
...
<tr>
    ...
    <td><button type="button"  class="btn btn-primary" onclick="for_alert_new('<?php echo $item_s_no; ?>','<?php echo $item_name.' - '.$item_size; ?>');" data-toggle="modal" data-target="#myModal" >Add/Edit Alert</button></td>
    </tr>
