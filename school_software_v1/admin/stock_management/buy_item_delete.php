...
$query="update purchase_detail set purchase_status='Deleted',$update_by_update_sql where invoice_number='$delete_record' and session_value='$session1' and purchase_status='Active'";
