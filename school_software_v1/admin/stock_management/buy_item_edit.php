      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title"><b>Books Purchase Invoice Edit</b></h1>
              <div class="btnadd">
              </div>
            </div>
            <!-- /.box-header -->
