...
function item_detail(serial_no){
    ...
    $.ajax({
    type: "POST",
    url: access_link+"stock_management/ajax_get_sales_item_details_uniform.php?item_s_no="+item_s_no+"",
    cache: false,
    success: function(detail){
...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"stock_management/add_sale_item_uniform_api.php",
            type: "POST",
            data: formdata,
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <div class="col-md-4"><h1 class="box-title"><b>Create Uniform Sale Invoice</b></h1></div>
