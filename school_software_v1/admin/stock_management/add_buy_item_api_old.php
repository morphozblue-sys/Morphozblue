...
if($result>0){
 ...
 $quer1="insert into new_stock_ledger(ledger_account_type,ledger_type,ledger_invoice_no,ledger_student_customer_id,ledger_invoice_date,ledger_item_s_no,ledger_payable_amount,ledger_payment_mode,ledger_cheque_bank_name,ledger_cheque_date,ledger_cheque_number,ledger_neft_bank_name,ledger_neft_bank_acount_number,ledger_status,session_value,$update_by_insert_sql_column) values('Debit','Vendor','$invoice_no','$vendor_s_no','$invoice_date','$ledger_item_s_no','$total_payable_amount','$payment_mode','$cheque_bank_name','$cheque_date','$cheque_no','$neft_bank_name','$neft_bank_account_no','Active','$session1',$update_by_insert_sql_value)";
