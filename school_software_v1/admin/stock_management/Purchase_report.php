...
$.ajax({
	  type: "POST",
	  url: access_link+"stock_management/ajax_purchase_report.php?order_by="+order_by+"&from_date="+from_date+"&to_date="+to_date+"",
	  cache: false,
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12 col-md-offset-1" id="search_detail">
				...
				<option value=" ORDER BY purchase_detail.invoice_date ASC">By Date</option>
				<option value=" ORDER BY purchase_detail.invoice_number ASC">By Invoice No</option>
				</select>
				</div>
				</div>
				<div class="col-md-2"></div>
