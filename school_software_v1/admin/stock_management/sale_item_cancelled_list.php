<?php include("../attachment/session.php"); ?>
    <section class="content-header">
      ...
      <li><a href="javascript:get_content('stock_management/stock_management')"><i class="fa fa-money"></i> <?php echo $language['Stock Management']; ?></a></li>
        <li class="active">Sale Cancelled List</li>
        </ol>
    </section>
    ...
    <section class="content">
		...
		<div class="box <?php echo $box_head_color; ?>">
            <div class="box-header with-border">
			  <div class="col-md-6"><h4>Books Sale Cancelled List</h4></div>
			  <div class="col-md-6" style="display:none;"><a href="javascript:get_content('stock_management/add_sale_item_through_checked')"> <button style="float:right;" type="button" class="btn btn-primary">+ Sale Item</button></a></div>
			</div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
					...
					<th style="display:none;">Sales Invoice</th>
                </tr>
                </thead>
...
$que="select * from sale_detail where sale_status='Cancelled' and session_value='$session1' group by invoice_number ORDER BY invoice_number DESC";
...
<tr>
   ...
   <td style="display:none;">
    <a href='<?php echo $pdf_path; ?>stock_invoice_reciept/Sales_invoice_reciept.php?id=<?php echo $invoice_number; ?>&student_customer_id=<?php echo $student_customer_id;?>&sales_type=<?php echo $sales_type; ?>' target="_blank"><button type="button" class="btn btn-success" >
