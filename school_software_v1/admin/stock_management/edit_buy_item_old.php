...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"stock_management/add_buy_item_api.php",
            type: "POST",
            data: formdata,
...
$query12 = "select * from purchase_detail where invoice_number='$invoice_number'";
$result12 = mysqli_query($conn73,$query12);
$row12 = mysqli_fetch_assoc($result12);
$vendor_s_no=$row12['vendor_s_no'];
...
?>
   ...
   <section class="content-header">
      ...
      <li><a href="javascript:get_content('stock_management/stock_management')"><i class="fa fa-money"></i> <?php echo $language['Stock Management']; ?></a></li>
        <li class="active">Edit Buy Item</li>
        </ol>
    </section>
	<!---*******************************************************************************************************************************************************************-->
    <!-- Main content -->
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title"><b>Edit Purchase Invoice</b></h1>
              <div class="btnadd">
              </div>
            </div>
            <!-- /.box-header -->
				...
				<div class="col-md-4">
    			    <div class ="form-group">
                        ...
                        <select class="form-control select2" name="vendor_id" style="width:100%;" required >
                            ...
                            ?>
                            <option value="<?php echo $vendor_s_no; ?>"<?php if($vendor_s_no==$vendor_s_no){ ?> selected <?php } ?>><?php echo $vendor_name.' ['.$vendor_contact.']'; ?></option>
                            <?php } ?>
                        </select>        
                    </div>
                </div>
				...
				<table class="table table-responsive">
				    ...
				    <tbody id="item_table">
    				    <tr>
    				        <td>
                                ...
                                <select name="item_name[]" class="form-control select2" id="item_name_1" style="width:100%;" required >
                                ...
                                ?>
                                <option value="<?php echo $item_s_no; ?>"><?php echo $item_name.' ['.$item_description.']'; ?></option>
                                <?php } ?>
                                </select>
				    ...
				    <tfoot>
				        ...
				        <tr>
    				        ...
    				        <input type='text' name='grand_total_quantity' placeholder='Total Quantity' id="grand_total_quantity" class='form-control' required readonly />
    				        </td>
    				        <td>&nbsp;</td>
    				        <td>
    				        <label>Grand Total  :-  <span style="color:red;" id="label_item_grand_total">0</span></label>
    				        <input type='text' name='item_grand_total' placeholder='Grand Total' id="item_grand_total" class='form-control' required readonly />
    				        </td>
    				        <td>&nbsp;</td>
				        </tr>
				    </tfoot>
