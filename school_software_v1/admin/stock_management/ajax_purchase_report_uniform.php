    ...
    <div class="col-md-12">
          ...
          <div class="box <?php echo $box_head_color; ?>">
			...
			if($from_date!=''){
				...
				$condition3=" and purchase_detail_uniform.invoice_date>='$from_date'";
			}else{
				$from_date2='';
				$condition3="";
			}
			...
			if($to_date!=''){
				...
				$condition4=" and purchase_detail_uniform.invoice_date<='$to_date'";
			}else{
				$to_date2='';
				$condition4="";
			}
			...
			<td><center><b>UNIFORM PURCHASE REPORT</b></center></td>
			...
			<td colspan="3"><center><b>From <?php echo $from_date2; ?> To <?php echo $to_date2; ?></b></center></td>
				...
				<table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
				    ...
				    <tbody>
					<?php
					$que1="select purchase_detail_uniform.*, new_stock_item_uniform.item_name, new_stock_item_uniform.item_class, vendor_detail.vendor_name from purchase_detail_uniform join new_stock_item_uniform on purchase_detail_uniform.item_s_no=new_stock_item_uniform.s_no join vendor_detail on purchase_detail_uniform.vendor_s_no=vendor_detail.s_no where purchase_detail_uniform.purchase_status='Active'$condition3$condition4$order_by";
