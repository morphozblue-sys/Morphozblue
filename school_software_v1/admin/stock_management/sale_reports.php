...
$.ajax({
	  type: "POST",
	  url: access_link+"stock_management/ajax_sale_report.php?sales_type="+rbtn_value+"&order_by="+order_by+"&from_date="+from_date+"&to_date="+to_date+"",
	  cache: false,
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <div class="col-md-4"><h3 class="box-title">Books Sale Report download</h3></div>
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-12 col-md-offset-1" id="search_detail">
				...
				<option value=" ORDER BY sale_detail.invoice_date ASC">By Date</option>
				<option value=" ORDER BY sale_detail.invoice_number ASC">By Invoice No</option>
				</select>
				</div>
				</div>
				<div class="col-md-2"></div>
