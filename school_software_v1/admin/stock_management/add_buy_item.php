...
function item_detail(serial_no){
    ...
    $.ajax({
    type: "POST",
    url: access_link+"stock_management/ajax_get_purchase_item_details.php?item_s_no="+item_s_no+"",
    cache: false,
    success: function(detail){
    var res=detail.split('|?|');
    $('#item_rate_'+serial_no).val(res[3]);
    }
    });
}
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h1 class="box-title"><b>Create Books Purchase Invoice</b></h1>
              <div class="btnadd">
              </div>
            </div>
            <!-- /.box-header -->
				    ...
				    <tbody id="item_table">
    				    <tr>
    				        ...
    				        <td>
                                ...
                                ?>
                                <option value="<?php echo $item_s_no; ?>"><?php echo $item_name.' ['.$item_class.']-['.$item_description.']'; ?></option>
                                <?php } ?>
                                </select>
