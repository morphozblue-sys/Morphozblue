    ...
    <div class="col-md-12">
          ...
          <div class="box <?php echo $box_head_color; ?>">
			...
			if($from_date!=''){
				...
				$condition3=" and sale_detail.invoice_date>='$from_date'";
			}else{
				$from_date2='';
				$condition3="";
			}
			...
			if($to_date!=''){
				...
				$condition4=" and sale_detail.invoice_date<='$to_date'";
			}else{
				$to_date2='';
				$condition4="";
			}
			...
			<td><center><b>BOOKS SALE REPORT</b></center></td>
			...
			<td colspan="3"><center><b>From <?php echo $from_date2; ?> To <?php echo $to_date2; ?></b></center></td>
				...
				<table id="example1" class="table table-bordered table-striped" border="1px" cellpadding="10px" cellspacing="0" width="100%">
					...
					if($sales_type=='Customer'){
					    $que1="select sale_detail.*, new_stock_item.item_name, new_stock_item.item_class, customer_detail.customer_name from sale_detail join new_stock_item on sale_detail.item_s_no=new_stock_item.s_no join customer_detail on sale_detail.student_customer_id=customer_detail.s_no where sale_detail.sale_status='Active' and sale_detail.sales_type='$sales_type'$condition3$condition4$order_by1";
					} else if ($sales_type=='Student'){
					      $que1="select sale_detail.*, new_stock_item.item_name, new_stock_item.item_class, student_admission_info.student_name from sale_detail join new_stock_item on sale_detail.item_s_no=new_stock_item.s_no join student_admission_info on sale_detail.student_customer_id=student_admission_info.student_roll_no where sale_detail.sale_status='Active' and sale_detail.sales_type='$sales_type'$condition3$condition4$order_by";
					}
