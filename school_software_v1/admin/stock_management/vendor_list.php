...
$.ajax({
type: "POST",
url: access_link+"stock_management/vendor_delete.php?id="+s_no+"",
cache: false,
    ...
    <section class="content">
		...
		<div class="box <?php echo $box_head_color; ?>">
            <div class="box-header with-border">
			  <div class="col-md-6"><h4>Vendor List</h4></div>
			  <div class="col-md-6"><a href="javascript:get_content('stock_management/add_vendor')"> <button style="float:right;" type="button" class="btn btn-primary">+ Add New Vendor</button></a></div>
			</div>
...
<?php
$que="select * from vendor_detail where vendor_status='Active' ORDER BY s_no DESC";
...
<tr>
    ...
    <td>
    <center>
    <a href="javascript:post_content('stock_management/vendor_edit','id=<?php echo $s_no; ?>')" style="color:#fff;"><input type="button" value="Edit" class="btn btn-default" style="background-color:#00a654;color:#fff;"></a> &nbsp;&nbsp;&nbsp;&nbsp;
