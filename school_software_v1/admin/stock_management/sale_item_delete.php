...
$query="update sale_detail set sale_status='Deleted',$update_by_update_sql where invoice_number='$delete_record' and session_value='$session1' and sale_status='Active'";
