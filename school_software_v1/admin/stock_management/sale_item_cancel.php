...
$query0="select * from sale_detail where invoice_number='$delete_record' and session_value='$session1' and sale_status='Active'";
...
$query="update sale_detail set sale_status='Cancelled',$update_by_update_sql where invoice_number='$delete_record' and session_value='$session1' and sale_status='Active'";
