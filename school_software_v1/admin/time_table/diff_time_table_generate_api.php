...
$que11="update school_info_class_period set period_start_time='$period_start_time1[$i]',period_end_time='$period_end_time1[$i]',$update_by_update_sql  where period_code='$period_code1[$i]' and class_code='$class_code_hidden'";
