...
$que="select * from class_time_table_new where class_code='$class_name' and section='$section'  and group_name='$student_class_group' and stream_code='$student_class_stream' ";
...
<tr align='center'>
	...
	<th><a href='<?php echo $pdf_path; ?>time_table/<?php echo 'new_'.$time_table_pdf; ?>?class=<?php echo $time_table_student_class; ?>&section=<?php echo $time_table_section; ?>&student_class_stream=<?php echo $student_class_stream; ?>&student_class_group=<?php echo $student_class_group; ?>' target="_blank"><button type="button" class="btn btn-success" >Print</th>
</tr>
<?php } ?>