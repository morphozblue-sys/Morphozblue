...
$query = "select  class_code,period_code FROM school_info_class_period_new";
if(!mysqli_query($conn73,$query)) { 
   $alter = "ALTER TABLE `school_info_class_period_new` ADD `class_code` VARCHAR(20) NOT NULL AFTER `s_no`, ADD `period_code` VARCHAR(20) NOT NULL AFTER `class_code`;"; 
   mysqli_query($conn73,$alter) or die(mysqli_error($conn73));
}
					$que="select * from school_info_class_period_new where class_code=''";
					...
					$period_coloum_teacher_saturday=$period_code1."_teacher_saturday";
				 	$que1="select * from class_time_table_new where class_code='$class_name' and section='$section'  and group_name='$student_class_group' and stream_code='$student_class_stream'";
					...
					$query1="insert into class_time_table_new(class,class_code,section,group_name,stream_code)values('$class_name1','$class_name','$section','$student_class_group','$student_class_stream')";
