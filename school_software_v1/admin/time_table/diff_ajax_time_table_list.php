...
while($row321=mysqli_fetch_assoc($run321)){
	$time_table_pdf ="diff_". $row321['time_table_pdf'];
}	
...
<tr align='center'>
	...
	<th><a href='<?php echo $pdf_path; ?>time_table/<?php echo $time_table_pdf; ?>?class=<?php echo $time_table_student_class; ?>&section=<?php echo $time_table_section; ?>' target="_blank"><button type="button" class="btn btn-success" >Print</th>
</tr>
<?php } ?>