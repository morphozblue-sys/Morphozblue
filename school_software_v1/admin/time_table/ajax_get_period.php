...
<td> <select name="subject_name_monday[]" class="form-control" id='<?php echo "subject_name_monday_".$serial_no ?>' style="width:200px">
<!--onchange="fill_subject_name('<?php echo $serial_no; ?>');-->
...
<td><select name="teacher_name_monday[]" class="form-control"  id="<?php echo "teacher_name_monday_".$serial_no ?>" style="width:150px" >
<!--onchange="fill_teacher_name(<?php echo $serial_no; ?>);-->
...
<td> <select name="subject_name_tuesday[]" class="form-control" id='<?php echo "subject_name_tuesday_".$serial_no ?>'    style="width:150px">
...
<td> <select name="teacher_name_tuesday[]" class="form-control" id="<?php echo "teacher_name_tuesday_".$serial_no ?>"  style="width:150px">
...
<td> <select name="subject_name_wednesday[]" class="form-control" id='<?php echo "subject_name_wednesday_".$serial_no ?>'  style="width:150px">
...
<td> <select name="teacher_name_wednesday[]" class="form-control" id='<?php echo "teacher_name_wednesday_".$serial_no ?>'  style="width:150px">
...
<td> <select name="subject_name_thursday[]" class="form-control" id='<?php echo "subject_name_thursday_".$serial_no ?>'  style="width:150px">
...
<td> <select name="teacher_name_thursday[]" class="form-control"  id='<?php echo "teacher_name_thursday_".$serial_no ?>'  style="width:150px">
...
<td> <select name="subject_name_friday[]" class="form-control" id='<?php echo "subject_name_friday_".$serial_no ?>'  style="width:150px">
...
<td> <select name="teacher_name_friday[]" class="form-control"  id='<?php echo "teacher_name_friday_".$serial_no ?>'  style="width:150px">
...
<td> <select name="subject_name_saturday[]" class="form-control" id='<?php echo "subject_name_saturday_".$serial_no ?>'  style="width:150px">
...
<td> <select name="teacher_name_saturday[]" class="form-control" id='<?php echo "teacher_name_saturday_".$serial_no ?>'  style="width:150px">
