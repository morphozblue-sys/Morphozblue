...
$quer12="update school_info_class_period set period_name='$period_name',period_start_time='$period_start_time',period_end_time='$period_end_time' where s_no='$period_code_hidden'";
