			  ...
			  <table id="" class="table table-bordered table-striped">
				...
				<tr>
				  <td colspan="10">
					...
					<div class="col-md-3">
					<label>Date</label>
					<input type="date" name="verify_date" id="verify_date" value="<?php echo date('Y-m-d'); ?>" class="form-control" />
					</div>
					<div class="col-md-3">
					<label>Remark</label>
					<input type="text" name="remark" id="remark" placeholder="Remark" value="" class="form-control" />
					</div>
					<div class="col-md-3 banking" style="display:none;" >
					<label>Bank Name</label>
					<input type="text" name="bank_name" id="bank_name" placeholder="Bank Name" value="" class="form-control" />
					</div>
					<div class="col-md-3 banking" style="display:none;" >
					<label>Cheque/Transaction Id</label>
					<input type="text" name="cheque_dd_no" id="cheque_dd_no" placeholder="Cheque/Transaction Id" value="" class="form-control" />
					</div>
					<div class="col-md-3 banking" style="display:none;" >
					<label>Cheque/Transaction Date</label>
					<input type="date" name="cheque_dd_date" id="cheque_dd_date" value="" class="form-control" />
					</div>
					<div class="col-md-3">
					<label>Total Amount</label>
					<input type="number" name="challan_amount" id="challan_amount" value="" class="form-control" readonly />
					</div>
					<div class="col-md-3">
					...
					<div class="col-md-3" id="for_paid_amount" style="display:none;">
					<label>Paid Amount</label>
					<input type="number" name="challan_paid_amount" id="challan_paid_amount" value="" class="form-control" oninput="for_balance(this.value);" placeholder="Paid Amount" />
					</div>
					<div class="col-md-3">
					<label>Balance</label>
					<input type="number" name="challan_balance" id="challan_balance" value="0" class="form-control" readonly />
					</div>
					</div>
				  </td>
				</tr>
