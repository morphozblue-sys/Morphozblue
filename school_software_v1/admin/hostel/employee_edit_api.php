...
include("../attachment/session.php");
 ...
 echo $quer="update hostel_staff_info set emp_name='$emp_name',emp_gender='$emp_gender',emp_dob='$emp_dob',emp_father='$emp_father',emp_email='$emp_email',emp_mobile='$emp_mobile',emp_address='$emp_address',emp_qualification='$emp_qualification',emp_doj='$emp_doj',emp_designation='$emp_designation',emp_casual_leave='$emp_casual_leave',emp_pan_card_no='$emp_pan_card_no',emp_bank_name='$emp_bank_name',emp_account_no='$emp_account_no',emp_ifsc_code='$emp_ifsc_code',emp_basic_salary='$emp_basic_salary',emp_pf_number='$emp_pf_number',emp_uid_no='$emp_uid_no',remarks='$remarks',$update_by_update_sql  where s_no='$s_no'";
