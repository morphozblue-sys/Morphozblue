<?php include("../attachment/session.php"); ?>
    ...
    <ol class="breadcrumb">
	    ...
	    <li><a href="javascript:get_content('hostel/hostel_account')"><i class="fa fa-bed"></i> <?php echo $language['Hostel Account']; ?></a></li>
	    <li class="Active"> <?php echo $language['Hostel Expense List']; ?></li>
	</ol>
    </section>
...
$.ajax({
type: "POST",
url: access_link+"hostel/purchase_delete.php?id="+s_no+"",
cache: false,
success: function(detail){
	  var res=detail.split("|?|");
			   if(res[1]=='success'){
				  alert_new('Successfully Deleted','green');
				   get_content('hostel/hostel_expenses');
			   }else{
               //alert_new(detail); 
			   }
}
