...
while ($row01 = mysqli_fetch_assoc($run01)) {
    ...
    $fees_code11 .= $seprator . $row01['fees_code'];
    $seprator = '|?|';
    $fee_sno++;
}
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="javascript:get_content('school_info/add_bus_fee_category_monthly_installmentwise')"><i class="fa fa-bus"></i> Fee Category List</a></li>
    <li class="active">Edit Bus Fee Type</li>
  </ol>
</section>
...
<div style="padding:0 10px 30px;">
  <div class="si-card">
    <div class="si-card-header">
      ...
      <h4>Bus Fee Type <span style="font-weight:400;font-size:12px;opacity:.7;">(Monthly / Installment)</span>
    ...
    <div class="si-card-body">
      <form id="my_form">
        ...
        <div class="row" style="margin-bottom:18px;">
          <div class="col-md-5">
            <div class="si-fg">
              <label>Bus Fee Type <span class="req">*</span></label>
        ...
        <div style="margin-top:20px;text-align:center;">
          ...
          <button type="button" class="si-btn si-btn-ghost si-btn-lg" style="margin-left:10px;"
            onclick="get_content('school_info/add_bus_fee_category_monthly_installmentwise')">
