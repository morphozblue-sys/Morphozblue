...
function form_submit() {
  ...
  $.ajax({
    type: "POST",
    url: access_link + "school_info/exam_type_add_monthly_api.php",
    data: payload,
    success: function (detail) {
      ...
      if (res[1] === 'success') {
        ...
        $('#myModal').one('hidden.bs.modal', function () {
          get_content('school_info/exam_type_add_monthly');
        });
        $('#myModal').modal('hide');
      } else {
...
<div style="padding:0 10px 30px;">
  ...
  <div class="si-card">
    <div class="si-card-header">
      ...
      <h4><?php echo $language['Add exams Type']; ?> (Monthly)</h4>
    </div>
    <div class="si-card-body">
      ...
      while ($row3 = mysqli_fetch_assoc($run3)):
          ...
          $que  = "select * from school_info_exam_types_monthly where class_code='$class_code' and (session_value='$session1' || session_value='') $filter37";
