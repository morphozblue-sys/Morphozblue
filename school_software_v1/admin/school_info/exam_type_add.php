...
$(document).ready(function () {
  ...
  $(document).on('click', '.si-class-toggle', function () {
    var block = $(this).closest('.si-class-block');
...
<div style="padding:0 10px 30px;">
  ...
  <div class="si-card">
    <div class="si-card-header">
      <div class="si-hdr-ico"><i class="fa fa-pencil-square-o"></i></div>
      <h4><?php echo $language['Add exams Type']; ?></h4>
    </div>
    <div class="si-card-body">
      ...
      while ($row3 = mysqli_fetch_assoc($run3)):
          ...
          $que  = "select * from school_info_exam_types where class_code='$class_code' and (session_value='$session1' || session_value='') $filter37";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="si-fg">
          ...
          <div class="si-iw">
            <i class="fa fa-pencil-square-o ico"></i>
