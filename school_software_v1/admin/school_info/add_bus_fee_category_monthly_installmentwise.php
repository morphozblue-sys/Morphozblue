...
<div style="padding:0 10px 30px;">
  <div class="si-card">
    <div class="si-card-header">
      ...
      <h4>Bus Fee Category <span style="font-weight:400;font-size:12px;opacity:.7;">(Monthly / Installment)</span></h4>
    </div>
            ...
            <tr>
              ...
              <td class="cen">
                <button type="button" class="si-btn si-btn-ok" style="padding:5px 14px;font-size:12px;"
                  onclick="post_content('school_info/bus_fee_category_monthly_installmentwise_edit','bus_fee_category_code=<?php echo htmlspecialchars($code,ENT_QUOTES); ?>')">
            ...
            <tr>
              <td colspan="<?php echo 4 + count($classes); ?>" class="cen" style="padding:10px;">
                <button type="button" class="si-btn si-btn-pri" style="padding:6px 18px;font-size:12px;"
                  onclick="post_content('school_info/bus_fee_category_monthly_installmentwise_edit','bus_fee_category_code=<?php echo htmlspecialchars($fee_code_blank,ENT_QUOTES); ?>')">
