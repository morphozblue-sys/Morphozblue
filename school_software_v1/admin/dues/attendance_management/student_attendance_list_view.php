...
var month=document.getElementById('student_attendance_month').value;
var year=document.getElementById('student_attendance_year').value;
	var data12="student_id="+student_id+"&month="+month+"&year="+year;
...
function month_list(value){
       ...
       $.ajax({
              ...
              success: function($detail){
                var str =$detail;                
                $("#student_attendance_month").html("<option value='All' >All</option>");
                $("#student_attendance_month").append(str);
          ...
          <?php
			...
			$student_attendance_month=$_GET['month'];
			$student_attendance_year=$_GET['year'];
  ...
  <div class="box <?php echo $box_head_color; ?> ">
			...
			<div class="col-md-2">
			  <label>Year : </label>
			      ...
			      ?>
			  <option <?php if($n==$student_attendance_year){ echo "selected"; } ?> value="<?php echo $n; ?>"><?php echo $n; ?></option>
<?php } ?>
			  </select>
			  </div>
			            <div class="col-md-2">
...
$current_month1=date('m');
     for($k=0;$k<$current_month1;$k++){
         ...
         if($y<10){
          ...
          <option <?php if($y==$student_attendance_month){ echo "selected"; } ?> value="<?php echo $y; ?>"><?php echo $month_array[$k]; ?></option>
         <?php
     }
 ?>
			  </select>
        ...
        <div class="box <?php echo $box_head_color; ?> ">
              ...
              <table id="example1" class="table table-bordered table-striped" style="width: 1500px; overflow: auto;">
                ...
                <tr>
                  ...
                  <th colspan="10">Name : <?php echo $student_name; ?>   |   Class :<?php echo $student_class; ?>   |   Section :<?php echo $student_class_section; ?></th>
                  <th  colspan="30"><?php echo strtoupper($month_wise); ?> Month Attendance</th>
                </tr>
                </thead>
                <tbody id="stud_list">
                <tr>
				...
				$que="select * from student_attendance where attendance_roll_no='$student_id' and month='$month_arrry[$r]' and year='$year_arrry[$r]' order by s_no DESC LIMIT 1";
				...
				$s_no=$row['s_no'];
				$student_id = $row['attendance_roll_no'];
				$student_rfid = $row['attendance_rf_id_no'];
                ...
                <tr>
				  ...
				  $total_sunday=0;
				  $total_not_mark=0;
				   $date3='-'.$month_arrry[$r].'-'.$year_arrry[$r];
				    for($i1=1;$i1<=31;$i1++){
				         $holiday[$i1]='';
				         $holiday_name[$i1]='';
				    }
