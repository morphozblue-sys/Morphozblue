...
while($row15=mysqli_fetch_assoc($run15)){
	...
	$student_dob_image=$row15['student_dob_image'];
    ...
    $num=1;
	echo $student_name."|?|".$student_class."|?|".$student_class_section."|?|".$student_father_name."|?|".$student_father_contact_number."|?|".$student_gender."|?|".$student_date_of_birth."|?|".$student_category."|?|".$student_roll_no."|?|".$session_value."|?|".$student_image."|?|".$student_adhar_number."|?|".$student_admission_number."|?|".$student_scholar_number."|?|".$company_name."|?|".$student_mother_name."|?|".$words."|?|".$words1."|?|".$student_dob_image."|?|".$num;
	}
?>