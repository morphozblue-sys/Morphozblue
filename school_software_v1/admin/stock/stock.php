...
window.scrollTo(0, 0);
    ...
    <section class="content">
	  <div class="box <?php echo $box_head_color; ?>">
		...
		<div class="box-body">
        <?php  if(!isset($_SESSION['stock_sub_panel_add_category'])){ ?>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#87A518;">
            ...
            <a href="javascript:get_content('stock/category_add')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>
		<?php } if(!isset($_SESSION['stock_sub_panel_category_list'])){ ?>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#053332;">
            ...
            <a href="javascript:get_content('stock/category_list')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
		</a>		
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box" style="background-color:#3B7A57;">
            ...
            <a href="javascript:get_content('stock/purchase_list')" class="small-box-footer"><?php echo $language['More info']; ?> <i class="fa fa-arrow-circle-right"></i></a>
				 	...
				 	<?php } if(!isset($_SESSION['stock_sub_panel_buy_sale'])){ ?>
 <a href="javascript:get_content('stock/item_list')">
        <div class="col-lg-3 col-xs-6">
