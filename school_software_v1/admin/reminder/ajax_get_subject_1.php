<?php include("../attachment/session.php");
                   ...
                   echo   $query="select * from school_info_subject_info where stream_name='$student_class_stream' and group_name='$student_class_group' and class='$class' and (session_value='$session1' || session_value='') $filter37";
