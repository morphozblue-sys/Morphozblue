...
$.ajax({
type: "POST",
url: access_link+"attendance_management/report_student_attendance_studentwise_ajax.php?student_attendance_class="+class_name+"&student_attendance_year="+student_attendance_year+"&student_attendance_month="+student_attendance_month+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"&section="+class_section+"&attendance_report_type="+attendance_report_type+"&attendance_date="+attendance_date+"&attendance_type="+attendance_type,
cache: false,
success: function(detail){
