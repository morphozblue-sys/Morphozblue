  ...
  document.getElementById('s_no_'+i).value=0;
	...
	function hindi_typing_answer(value1){
     ...
     $("#answer_box_"+value1).focus();
		  ...
		  <center><input type="submit" class="addButton btn  btn-success" name="long" value="submit" />
			<input type="button" class="addButton btn  btn-success" id="addButton" onclick="add_more5();" value="Add More" /></center><br/>
		 <!-- /.box -->
<script>	
