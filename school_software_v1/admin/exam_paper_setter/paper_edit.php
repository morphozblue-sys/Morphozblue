...
height: 2px !important;
    ...
    <section class="content-header">
	 ...
	 <li><a href="javascript:get_content('exam_paper_setter/exam_paper_setter')"><i class="fa fa-dashboard"></i> <?php echo $language['Paper Setter']; ?></a></li>
       <li><a href="javascript:get_content('exam_paper_setter/total_paper_list')"><i class="fa fa-scribd" aria-hidden="true"></i><?php echo $language['Total Paper List']; ?></a></li>
        <li class="active"><?php echo $language['Edit Paper']; ?></li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-8 col-xs-offset-2" style="border:1px solid black;">
          ...
          <div class="box <?php echo $box_head_color; ?>" >
            ...
            <div class="box-header with-border">
              <center><h2><b><?php echo $school_info_school_name; ?></b></h2></center>
            </div>
			...
			?>
			<div class="box-header with-border">
              <center><h3><b><?php if(mysqli_num_rows($run11)>0){ echo $exam_type; } ?></b></h3></center>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive" style="height: 1000px;overflow-y: auto;">
              <table id="example1" class="table">
				...
				?>
                <tr>
				  <td colspan="3"><b><?php if($language=='English'){ echo "Exam Date : "; }elseif($language=='Hindi'){ echo "परीक्षा दिनांक : "; } ?><?php echo $exam_date; ?></b></td>
				  <td colspan="2"><b><?php if($language=='English'){ echo "Class : "; }elseif($language=='Hindi'){ echo "कक्षा : "; } ?><?php echo $question_class; ?></b></td>
                </tr>
				<tr>
				  <td colspan="3"><b><?php if($language=='English'){ echo "Exam Time : "; }elseif($language=='Hindi'){ echo "परीक्षा समय : "; } ?><?php echo $exam_time_from."  -  ".$exam_time_to; ?></b></td>
				  <td colspan="2"><b><?php if($language=='English'){ echo "Marks : "; }elseif($language=='Hindi'){ echo "पूर्णांक : "; } ?><?php echo $total_marks; ?></b></td>
                </tr>
				<tr>
				  <td colspan="3"><b><?php if($language=='English'){ echo "Subject : "; }elseif($language=='Hindi'){ echo "विषय : "; } ?><?php echo $question_subject; ?></b></td>
				  <td colspan="2"><b><?php if($language=='English'){ echo "Roll No : "; }elseif($language=='Hindi'){ echo "अनुक्रमांक : "; } ?>..............</b></td>
                </tr>
				<tr>
...
<tr>
  <td>&nbsp;</td>
  <?php if($language=='English'){ echo "<td colspan='4'><h4><b>INSTRUCTIONS - </b></h4></td>"; }elseif($language=='Hindi'){ echo "<td colspan='4'><h4><b>निर्देश - </b></h4></td>"; } ?>
...
?>
						<tr>
						  ...
						  <td><a href="javascript:post_content('exam_paper_setter/paper_question_delete','id=<?php echo $s_no; ?>&p_id=<?php echo $id; ?>&language=<?php echo $language; ?>')"><button type="button" onclick="return valid();" class="btn btn-danger"><?php if($language=='English'){ echo "Delete"; }elseif($language=='Hindi'){ echo "मिटायें"; } ?></button></a></td>
						</tr>
						<?php
						$j=0;
						for($i=1;$i<=$options;$i++){
				...
				?>
				 ...
				 ?>
						...
						<tr>
						  <td>&nbsp;</td>
						  <td><?php if($language=='English'){ if($j=='1'){ echo 'A.'; }elseif($j=='2'){ echo 'B.'; }elseif($j=='3'){ echo 'C.'; }elseif($j=='4'){ echo 'D.'; }elseif($j=='5'){ echo 'E.'; } }elseif($language=='Hindi'){ if($j=='1'){ echo 'अ.'; }elseif($j=='2'){ echo 'ब.'; }elseif($j=='3'){ echo 'स.'; }elseif($j=='4'){ echo 'द.'; }elseif($j=='5'){ echo 'इ.'; } } ?></td>
						  <td width="800px;"><label style="width:250px;font-weight:normal;"><?php echo $option11; ?></label><label style="width:100px;"></label><label style="width:250px;font-weight:normal;"><?php echo $option21; ?></label></td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
						</tr>
						<?php
				...
				?>
						...
						<tr>
						  <td>&nbsp;</td>
						  <td><?php if($language=='English'){ if($j=='1'){ echo 'A.'; }elseif($j=='2'){ echo 'B.'; }elseif($j=='3'){ echo 'C.'; }elseif($j=='4'){ echo 'D.'; }elseif($j=='5'){ echo 'E.'; } }elseif($language=='Hindi'){ if($j=='1'){ echo 'अ.'; }elseif($j=='2'){ echo 'ब.'; }elseif($j=='3'){ echo 'स.'; }elseif($j=='4'){ echo 'द.'; }elseif($j=='5'){ echo 'इ.'; } } ?></td>
						  <td width="800px;"><label style="width:250px;font-weight:normal;"><?php echo $option11_1; ?></label><label style="width:100px;"></label><label style="width:250px;font-weight:normal;"><?php echo $option21_1; ?></label></td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
						</tr>
						<?php
