...
$que="select * from question_matching where question_class='$class' and paper_language='$language' and question_subject='$subject'$chap1$book1";
...
?>	  
				...
				<tr>
				  ...
				  <td colspan="10"><label style="width:300px;font-weight:normal;"><?php echo $option11; ?></label><label style="width:100px;"></label><label style="width:300px;font-weight:normal;"><?php echo $option21; ?></label></td>
				</tr>
				<?php
				}
				}
