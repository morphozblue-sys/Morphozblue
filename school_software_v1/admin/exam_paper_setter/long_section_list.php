...
$que="select * from question_long where long_question_class='$class' and long_question_subject='$subject'$chap $question_book1 and paper_language='$paper_language2'";
