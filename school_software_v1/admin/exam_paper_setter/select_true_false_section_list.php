...
<!-- /.box-header -->
<br/>  
<div class="box-body table-responsive no-padding" id="" id="" style="height: 400px;overflow-y: auto;" ><br/>
<table class="table">
...
$que="select * from question_true_false where question_class='$class' and paper_language='$language' and question_subject='$subject'$chap1$book1";
