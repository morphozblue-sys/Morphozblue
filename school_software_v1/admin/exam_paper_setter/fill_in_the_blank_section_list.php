...
$que="select * from question_fill_in_the_blank where question_class='$class' and question_subject='$subject'$chap $question_book1 and paper_language='$paper_language2'";
					...
					<div class="box-body table-responsive no-padding" id="div_1" ><br/>
					  ...
					  <table class="table table-striped">
						<tr>
						  ...
						  <?php }?>
						  <th style="width:70px"><?php echo $marks; ?><br/><button type="button"  class="btn btn-danger" onclick="return valid('<?php echo $s_no; ?>','question_fill_in_the_blank');" ><?php echo $language['Delete']; ?></button></th>
						</tr>
						<tr>
						  <td style="text-align:right; ">A.</td>
						  <td style="width:700px"><?php echo $option_1; ?></td>
						  <td colspan="2"> <b>(<?php echo $answer_1; ?>)</b></td>
						 </tr>
						<tr>
						  <td style="text-align:right; ">B.</td>
						  <td style="width:700px"><?php echo $option_2; ?></td>
						  <td colspan="2"> <b>(<?php echo $answer_2; ?>)</b></td>
					    </tr>
						<tr>
						  <td style="text-align:right; ">C.</td>
						  <td style="width:700px"><?php echo $option_3; ?></td>
						  <td colspan="2"> <b>(<?php echo $answer_3; ?>)</b></td>
						</tr>
					<?php if($options>3){?>
						<tr>
						  <td style="text-align:right; ">D.</td>
						  <td style="width:700px"><?php echo $option_4; ?></td>
						  <td colspan="2"> <b>(<?php echo $answer_4; ?>)</b></td>
						</tr>
						<?php }?>
						<?php if($options>4){?>
						<tr>
						  ...
						  <td colspan="2"> <b>(<?php echo $answer_5; ?>)</b></td>
						</tr>
						<?php }?>
