    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
	 <script type="text/javascript">
            ...
            <!-- /.box-body -->
				  ...
				  <center><input type="submit" class="addButton btn  btn-success" name="true_false" value="submit"  />
					<input type="button" class="addButton btn  btn-success" id="addButton" onclick="add_more2();" value="Add More" /></center><br/>
