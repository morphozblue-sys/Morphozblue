...
$que="select * from question_one_word where question_class='$class' and question_subject='$subject'$chap $question_book1 and paper_language='$paper_language2'";
					...
					<div class="box-body table-responsive no-padding" id="div_1" ><br/>
					  ...
					  <table class="table table-striped">
						<tr>
						  ...
						  <?php }?>
						  <th style="width:70px"><?php echo $marks; ?><br/><button type="button"  class="btn btn-danger" onclick="return valid('<?php echo $s_no; ?>','question_one_word');" ><?php echo $language['Delete']; ?></button></th>
						</tr>
						<tr>
