...
$marksheet_monthly_pdf = $row321['marksheet_monthly_pdf'];
}
...
<?php if($_SESSION['database_name']=='simptczo_saraswatibalmandirbhaunkhedi'){?>
<td><a target="_blank" href="<?php echo $pdf_path; ?>marksheet_page/marksheet_examwise_monthly_sbms.php?class=<?php echo $student_class; ?>&section=<?php echo $student_section; ?>&roll_no=<?php echo $student_roll_no; ?>&exam_type=<?php echo $exam_type; ?>&student_class_group=<?php echo $student_class_group; ?>&student_class_stream=<?php echo $student_class_stream; ?>&session1=<?php echo $session1; ?>">View Marksheet</a></td>
<?php }else{?>
<td><a target="_blank" href="<?php echo $pdf_path; ?>marksheet_page/marksheet_examwise_monthly.php?class=<?php echo $student_class; ?>&section=<?php echo $student_section; ?>&roll_no=<?php echo $student_roll_no; ?>&exam_type=<?php echo $exam_type; ?>&student_class_group=<?php echo $student_class_group; ?>&student_class_stream=<?php echo $student_class_stream; ?>&session1=<?php echo $session1; ?>">View Marksheet</a></td>
<?php } ?>
</tr>
<?php
}
