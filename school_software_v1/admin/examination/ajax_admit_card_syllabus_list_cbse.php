...
$query="select * from school_info_subject_info where class_code='$class_code' and group_name='$student_class_group' and stream_name='$student_class_stream' and (session_value='$session1' || session_value='') $filter37";
$serial_no=0;
...
$syllabus_content=$row[$exam_term.'_'.$exam_type.'_syllabus_content'];
$syllabus_show_hide=$row[$exam_term.'_'.$exam_type.'_syllabus_show_hide'];
