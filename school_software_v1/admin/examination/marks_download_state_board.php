...
function for_list(){
			...
			if(sheet_type=='all'){    
             ...
             $.ajax({
			  type: "POST",
              url: access_link+"examination/ajax_marks_download_state_board1.php?id="+student_class+"&student_section="+student_class_section+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"&subject_type="+subject_type+"&order_by="+order_by+"",
              cache: false,
			...
			$('#marks_download').html(loader_div);
             $.ajax({
			  type: "POST",
              url: access_link+"examination/ajax_marks_download_state_board.php?id="+student_class+"&student_section="+student_class_section+"&student_exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"&subject_type="+subject_type+"&order_by="+order_by+"",
              cache: false,
              success: function(detail){
              $('#marks_download').html(detail);
