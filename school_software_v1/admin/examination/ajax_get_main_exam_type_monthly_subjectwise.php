<?php include("../attachment/session.php");
                    ...
                    $query="select * from school_info_exam_types where class_code='$class_code' and (session_value='$session1' || session_value='') $filter37";
                    ...
                    while($row=mysqli_fetch_assoc($res)){
                         $exam_type=$row['exam_type']; 
							  ...
							  if($exam_type!=''){
                               ?>
						       <div class="col-md-2">
						       <input type="checkbox" value="<?php echo $exam_code; ?>" onclick="for_list();" class="sel_exam2" /> <?php echo $exam_type; ?>
						       </div>
					     <?php } } ?>