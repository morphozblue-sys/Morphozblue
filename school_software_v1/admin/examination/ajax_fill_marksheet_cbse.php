...
$exam_table=$exam_term."_";
 ...
 $query5="select * from school_info_subject_info where class='$student_class' and subject_code='$subject_name' and group_name='$student_class_group' and stream_name='$student_class_stream' and session_value='$session1'$filter37";
...
$query3="select * from student_admission_info where student_class='$student_class' and student_class_section='$student_section' and student_class_group='$student_class_group' and student_class_stream='$student_class_stream' and student_status='Active' and session_value='$session1'$filter37$order_by";
$serial_no=0;
...
<td style="<?php if($_SESSION['examination_fill_marks_total_day_field']=='no212'){echo 'display:none'; } if($_SESSION['software_link']=="stlorentzschool"){echo 'display:none';}?>"><input type="text" name="total_attendance[]" value="<?php echo $total_attendance; ?>"></td>
<td style="<?php if($_SESSION['examination_fill_marks_prasent_day_field']=='no213'){echo 'display:none'; } if($_SESSION['software_link']=="stlorentzschool"){echo 'display:none';} ?>"><input type="text" name="total_present[]" value="<?php echo $total_present; ?>"></td>
<td style="<?php if($_SESSION['examination_fill_marks_remarks_field']=='no214'){echo 'display:none'; } if($_SESSION['software_link']=="stlorentzschool"){echo 'display:none';} ?>"><input type="text" name="attendance_remark[]" value="<?php echo $attendance_remark; ?>"></td>
