...
$blank_field_1=$_POST['blank_field_1'];
...
for($i=0; $i<$count; $i++){
$admit_card_date_name1=$exam_type."_time_date";
$exam_time_from_name1=$exam_type."_time_from";
$exam_time_to_name1=$exam_type."_time_to";
$exam_admit_card_show1=$exam_type."_admit_card_show";

echo $admit_card_sitting1=$exam_type."_sitting";

$exam_admit_card_show1=$exam_type."_admit_card_show";
 $quer="update school_info_subject_info set $admit_card_date_name1='$admit_card_date[$i]',$exam_time_from_name1='$admit_card_exam_time_from[$i]',$exam_time_to_name1='$admit_card_exam_time_to[$i]',$exam_admit_card_show1='$admit_card_show[$i]',blank_field_1='$blank_field_1[$i]',$update_by_update_sql  where class_code='$class_code[$i]' and subject_code='$student_subject_code[$i]' and group_name='$student_class_group' and stream_name='$student_class_stream' and session_value='$session1'$filter37";
