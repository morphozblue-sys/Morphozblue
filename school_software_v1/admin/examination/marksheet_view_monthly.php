...
$marksheet_exam_wise_monthly_all_pdf = $row321['marksheet_monthly_pdf'];

}	
?>
					<input type="hidden"  id="pdf_path" value="<?php echo $pdf_path; ?>" >
			<input type="hidden"  id="marksheet_exam_wise_monthly_all_pdf" value="<?php echo $marksheet_exam_wise_monthly_all_pdf; ?>" >
