			...
			<form role="form" id="my_form" method="post" enctype="multipart/form-data">
			    ...
			    <div class="col-md-3 ">	
					<div class="form-group" >
					    ...
					    <select name="student_class" onchange="for_section(this.value,'<?php echo $student_class_section; ?>','<?php echo $exam_type; ?>');for_stream(this.value,'<?php echo $student_class_stream; ?>');" id="student_class" class="form-control" required>
					...
					<div class="form-group">
					  <label ><?php echo $language['Stream']; ?><font style="color:red"><b>*</b></font></label>
					    <select class="form-control" name="student_class_stream" id="student_class_stream" onchange="get_group(this.value,'<?php echo $student_class_group; ?>');" >
