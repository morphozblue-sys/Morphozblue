...
$attendance_remark11=$exam_type.'_attendance_remark';
 ...
 for($i=0; $i<$count; $i++){
 $quer="update examination_$exam_term set $exam_marks1='$student_marks[$i]',$total_attendance11='$total_attendance[$i]',$total_present11='$total_present[$i]',$attendance_remark11='$attendance_remark[$i]',$update_by_update_sql  where student_roll_no='$student_roll_no[$i]' and session_value='$session1'";
