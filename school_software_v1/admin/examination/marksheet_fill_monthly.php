...
<script type="text/javascript">
      function for_list(){ 
			...
			if(student_class_section!='' && student_class!='' && exam_type!='' && subject_name!='' ){
             ...
             $.ajax({
			  type: "POST",
             url:  access_link+"examination/ajax_fill_marksheet_monthly.php?id="+student_class+"&student_section="+student_class_section+"&subject_name="+subject_name+"&student_exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"&order_by="+order_by+"&select_month="+select_month+"",
              cache: false,
		...
		<div class="col-md-3" id="student_class_group_div" style="display:none;">				
			  ...
			  <div class="form-group" >
				...
				<select class="form-control" name="student_mark_add" id="student_mark_add" required>
				 ...
				 <div class="col-md-3 ">				
			     <div class="form-group" >
				 <label>Month <small>( For Attendance Calculation )</small></label>
...
<?php
$saa="select exam1_total_attendance from examination_monthly";
if(!mysqli_query($conn73,$saa)){
$qyyw="ALTER TABLE `examination_monthly` ADD exam1_total_attendance varchar(10) NOT NULL, ADD exam1_total_present varchar(10) NOT NULL, ADD exam1_attendance_remark varchar(50) NOT NULL, ADD exam2_total_attendance varchar(10) NOT NULL, ADD exam2_total_present varchar(10) NOT NULL, ADD exam2_attendance_remark varchar(50) NOT NULL, ADD exam3_total_attendance varchar(10) NOT NULL, ADD exam3_total_present varchar(10) NOT NULL, ADD exam3_attendance_remark varchar(50) NOT NULL, ADD exam4_total_attendance varchar(10) NOT NULL, ADD exam4_total_present varchar(10) NOT NULL, ADD exam4_attendance_remark varchar(50) NOT NULL, ADD exam5_total_attendance varchar(10) NOT NULL, ADD exam5_total_present varchar(10) NOT NULL, ADD exam5_attendance_remark varchar(50) NOT NULL, ADD exam6_total_attendance varchar(10) NOT NULL, ADD exam6_total_present varchar(10) NOT NULL, ADD exam6_attendance_remark varchar(50) NOT NULL, ADD exam7_total_attendance varchar(10) NOT NULL, ADD exam7_total_present varchar(10) NOT NULL, ADD exam7_attendance_remark varchar(50) NOT NULL, ADD exam8_total_attendance varchar(10) NOT NULL, ADD exam8_total_present varchar(10) NOT NULL, ADD exam8_attendance_remark varchar(50) NOT NULL, ADD exam9_total_attendance varchar(10) NOT NULL, ADD exam9_total_present varchar(10) NOT NULL, ADD exam9_attendance_remark varchar(50) NOT NULL, ADD exam10_total_attendance varchar(10) NOT NULL, ADD exam10_total_present varchar(10) NOT NULL, ADD exam10_attendance_remark varchar(50) NOT NULL;";
mysqli_query($conn73,$qyyw);
}