...
<script type="text/javascript">
      function for_list(){ 
			...
			if(student_class!='' && exam_type!=''){
             ...
             $.ajax({
			  type: "POST",
              url: access_link+"examination/ajax_admit_card_syllabus_list_cbse.php?class="+student_class+"&student_section="+student_class_section+"&student_exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"&exam_term="+exam_term+"",
              cache: false,
...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"examination/admit_card_cbse_syllabus_api.php",
            type: "POST",
            data: formdata,
			...
			////alert_new(detail);
			   ...
			   if(res[1]=='success'){
				   ...
				   get_content('examination/admit_card_cbse_syllabus');
            }
			}
         });
      });
      
function for_syllabus(){
...
var syllabus_pdf_path= document.getElementById('syllabus_pdf_path').value;
if(student_class!='' && exam_type!='' && exam_term!=''){
var pass_var="?student_class="+student_class+"&student_class_section="+student_class_section+"&exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"&exam_term="+exam_term+"";
window.open(syllabus_pdf_path+"admit_card/admit_card_cbse_syllabus_pdf.php"+pass_var, "_blank");
}else{
alert_new("Please Select All Required field That You Want to Print !!!",'red');
}
   ...
   <li><a href="javascript:get_content('index_content')"><i class="fa fa-dashboard"></i> Home</a></li>
	 <li><a href="javascript:get_content('examination/examination')"><i class="fa fa-id-card-o"></i> <?php echo $language['Examination']; ?></a></li>
	   <li class="active">Admit Card Syllabus Generate</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title">Admit Card Syllabus Generate</h3>
            </div>
            <!-- /.box-header -->
<!------------------------------------------------Start Registration form--------------------------------------------------->
			
            <div class="box-body "  >
<input type="hidden" id="syllabus_pdf_path" value="<?php echo $pdf_path; ?>" />
		...
		<div class="col-md-3" id="student_class_group_div" style="display:none;">				
		  ...
		  <div class="col-md-12">
		        ...
		        <input type="button" name="print" value="Print Syllabus" onclick="for_syllabus();" class="btn  btn-success" />
		        </center>
		  </div>
		  </form>
	      </div>
