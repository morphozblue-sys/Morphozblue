...
<script type="text/javascript">
      function for_list(){ 
			...
			if(student_class!='' && exam_type!=''){
             ...
             $.ajax({
			  type: "POST",
              url: access_link+"examination/ajax_admit_card_syllabus_list.php?class="+student_class+"&student_section="+student_class_section+"&student_exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"",
              cache: false,
...
window.scrollTo(0, 0);
    loader();
        $.ajax({
            url: access_link+"examination/admit_card_syllabus_api.php",
            type: "POST",
            data: formdata,
			...
			////alert_new(detail);
			   ...
			   if(res[1]=='success'){
				   ...
				   get_content('examination/admit_card_syllabus');
            }
			}
         });
      });
...
if(student_class!='' && exam_type!=''){
var pass_var="?student_class="+student_class+"&student_class_section="+student_class_section+"&exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"";
window.open(syllabus_pdf_path+"admit_card/admit_card_syllabus_pdf.php"+pass_var, "_blank");
}else{
