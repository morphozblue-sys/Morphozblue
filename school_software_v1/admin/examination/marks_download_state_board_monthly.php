...
function for_list(){
			...
			if(student_class_section!='' && student_class!='' && exam_type!='' ){
             ...
             $.ajax({
			  type: "POST",
              url: access_link+"examination/ajax_marks_download_state_board_monthly.php?id="+student_class+"&student_section="+student_class_section+"&student_exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"",
              cache: false,
