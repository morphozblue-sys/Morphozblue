...
<td><input type="checkbox" name="<?php echo 'sms_'.$student_roll_no; ?>" value="<?php echo $student_sms_contact_number; ?>" <?php if(strlen($student_sms_contact_number)==10){ ?> class="sms_checked" <?php }else{ ?> disabled <?php } ?> /></td>
